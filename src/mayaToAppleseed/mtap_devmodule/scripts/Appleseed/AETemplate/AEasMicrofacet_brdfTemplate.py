...
class AEasMicrofacet_brdfTemplate(BaseTemplate):
    def __init__(self, nodeName):
        BaseTemplate.__init__(self,nodeName)
        log.debug("AEasMicrofacet_brdfTemplate")
        self.thisNode = None
    ...
    def buildBody(self, nodeName):
        ...
        self.addControl("mdf", label="Microfacet Distribution Function")
        self.addControl("glossiness_multiplier", label="Glossiness Multiplier")
