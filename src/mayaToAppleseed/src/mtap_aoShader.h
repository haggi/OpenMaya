#ifndef MTAP_AO_SHADER_H
#define MTAP_AO_SHADER_H

#include <maya/MPxNode.h>

const MString mtap_aoShaderName = "mtap_aoShader";

class mtap_aoShader : public MPxNode
{
public:
					mtap_aoShader();
	virtual			~mtap_aoShader();
