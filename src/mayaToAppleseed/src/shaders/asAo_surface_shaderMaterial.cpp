#include "asAo_surface_shaderMaterial.h"
...
//
MTypeId	asAo_surface_shader::id( 0x0011CF8D );
...
//
void asAo_surface_shader::postConstructor( )
{
...
//
MObject  asAo_surface_shader::aTranslucenceCoeff;
MObject  asAo_surface_shader::aDiffuseReflectivity;
MObject  asAo_surface_shader::aInTransparency;
MObject  asAo_surface_shader::aColor;
MObject  asAo_surface_shader::aIncandescence;
MObject  asAo_surface_shader::aOutColor;
MObject  asAo_surface_shader::aOutTransparency;
MObject  asAo_surface_shader::aNormalCamera;
MObject  asAo_surface_shader::aNormalCameraX;
MObject  asAo_surface_shader::aNormalCameraY;
MObject  asAo_surface_shader::aNormalCameraZ;
MObject  asAo_surface_shader::aLightData;
MObject  asAo_surface_shader::aLightDirection;
MObject  asAo_surface_shader::aLightDirectionX;
MObject  asAo_surface_shader::aLightDirectionY;
MObject  asAo_surface_shader::aLightDirectionZ;
MObject  asAo_surface_shader::aLightIntensity;
MObject  asAo_surface_shader::aLightIntensityR;
MObject  asAo_surface_shader::aLightIntensityG;
MObject  asAo_surface_shader::aLightIntensityB;
MObject  asAo_surface_shader::aLightAmbient;
MObject  asAo_surface_shader::aLightDiffuse;
MObject  asAo_surface_shader::aLightSpecular;
MObject  asAo_surface_shader::aLightShadowFraction;
MObject  asAo_surface_shader::aPreShadowIntensity;
MObject  asAo_surface_shader::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asAo_surface_shader::max_distance;
MObject asAo_surface_shader::sampling_method;
MObject asAo_surface_shader::samples;
...
asAo_surface_shader::asAo_surface_shader() { }
asAo_surface_shader::~asAo_surface_shader() { }
...
// method.
//
// In this case creator simply returns a new asAo_surface_shader object.
//

void* asAo_surface_shader::creator()
{
    return new asAo_surface_shader();
}
...
MStatus asAo_surface_shader::initialize()
{
...
//
MStatus asAo_surface_shader::compute( const MPlug& plug, MDataBlock& block )
{
