...
// Plugin asAo_surface_shader Shader Class //
...
class asAo_surface_shader : public MPxNode
{
public:
                    asAo_surface_shader();
    virtual         ~asAo_surface_shader();
...
//---------------------------- automatically created attributes start ------------------------------------
	static    MObject max_distance;
	static    MObject sampling_method;
