#ifndef asAo_surface_shaderOverride_H
#define asAo_surface_shaderOverride_H
...
class asAo_surface_shaderOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~asAo_surface_shaderOverride();
...
private:
	asAo_surface_shaderOverride(const MObject& obj);
};

#endif // _asAo_surface_shaderOverride
