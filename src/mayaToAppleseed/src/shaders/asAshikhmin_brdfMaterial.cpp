#include "asAshikhmin_brdfMaterial.h"
...
//
MTypeId	asAshikhmin_brdf::id( 0x0011CF44 );
...
//
void asAshikhmin_brdf::postConstructor( )
{
...
//
MObject  asAshikhmin_brdf::aTranslucenceCoeff;
MObject  asAshikhmin_brdf::aDiffuseReflectivity;
MObject  asAshikhmin_brdf::aInTransparency;
MObject  asAshikhmin_brdf::aColor;
MObject  asAshikhmin_brdf::aIncandescence;
MObject  asAshikhmin_brdf::aOutColor;
MObject  asAshikhmin_brdf::aOutTransparency;
MObject  asAshikhmin_brdf::aNormalCamera;
MObject  asAshikhmin_brdf::aNormalCameraX;
MObject  asAshikhmin_brdf::aNormalCameraY;
MObject  asAshikhmin_brdf::aNormalCameraZ;
MObject  asAshikhmin_brdf::aLightData;
MObject  asAshikhmin_brdf::aLightDirection;
MObject  asAshikhmin_brdf::aLightDirectionX;
MObject  asAshikhmin_brdf::aLightDirectionY;
MObject  asAshikhmin_brdf::aLightDirectionZ;
MObject  asAshikhmin_brdf::aLightIntensity;
MObject  asAshikhmin_brdf::aLightIntensityR;
MObject  asAshikhmin_brdf::aLightIntensityG;
MObject  asAshikhmin_brdf::aLightIntensityB;
MObject  asAshikhmin_brdf::aLightAmbient;
MObject  asAshikhmin_brdf::aLightDiffuse;
MObject  asAshikhmin_brdf::aLightSpecular;
MObject  asAshikhmin_brdf::aLightShadowFraction;
MObject  asAshikhmin_brdf::aPreShadowIntensity;
MObject  asAshikhmin_brdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asAshikhmin_brdf::glossy_reflectance;
MObject asAshikhmin_brdf::shininess_v;
MObject asAshikhmin_brdf::shininess_u;
MObject asAshikhmin_brdf::glossy_reflectance_multiplier;
MObject asAshikhmin_brdf::diffuse_reflectance_multiplier;
MObject asAshikhmin_brdf::fresnel_multiplier;
MObject asAshikhmin_brdf::diffuse_reflectance;
...
asAshikhmin_brdf::asAshikhmin_brdf() { }
asAshikhmin_brdf::~asAshikhmin_brdf() { }
...
// method.
//
// In this case creator simply returns a new asAshikhmin_brdf object.
//

void* asAshikhmin_brdf::creator()
{
    return new asAshikhmin_brdf();
}
...
MStatus asAshikhmin_brdf::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	glossy_reflectance = nAttr.createColor("glossy_reflectance", "glossy_reflectance");
	nAttr.setDefault(0.5,0.5,0.5);
	CHECK_MSTATUS(addAttribute( glossy_reflectance ));

	shininess_v = nAttr.create("shininess_v", "shininess_v",  MFnNumericData::kFloat, 100.0);
	CHECK_MSTATUS(addAttribute( shininess_v ));

	shininess_u = nAttr.create("shininess_u", "shininess_u",  MFnNumericData::kFloat, 100.0);
	CHECK_MSTATUS(addAttribute( shininess_u ));

	glossy_reflectance_multiplier = nAttr.create("glossy_reflectance_multiplier", "glossy_reflectance_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( glossy_reflectance_multiplier ));

	diffuse_reflectance_multiplier = nAttr.create("diffuse_reflectance_multiplier", "diffuse_reflectance_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( diffuse_reflectance_multiplier ));
	...
	diffuse_reflectance = nAttr.createColor("diffuse_reflectance", "diffuse_reflectance");
	nAttr.setDefault(0.5,0.5,0.5);
	CHECK_MSTATUS(addAttribute( diffuse_reflectance ));
...
//
MStatus asAshikhmin_brdf::compute( const MPlug& plug, MDataBlock& block )
{
