...
// Plugin asAshikhmin_brdf Shader Class //
...
class asAshikhmin_brdf : public MPxNode
{
public:
                    asAshikhmin_brdf();
    virtual         ~asAshikhmin_brdf();
...
//---------------------------- automatically created attributes start ------------------------------------
	static    MObject glossy_reflectance;
	static    MObject shininess_v;
	static    MObject shininess_u;
	static    MObject glossy_reflectance_multiplier;
	static    MObject diffuse_reflectance_multiplier;
	static    MObject fresnel_multiplier;
	static    MObject diffuse_reflectance;
