#include "asBsdf_blendMaterial.h"
...
//
MTypeId	asBsdf_blend::id( 0x0011CF45 );
...
//
void asBsdf_blend::postConstructor( )
{
...
//
MObject  asBsdf_blend::aTranslucenceCoeff;
MObject  asBsdf_blend::aDiffuseReflectivity;
MObject  asBsdf_blend::aInTransparency;
MObject  asBsdf_blend::aColor;
MObject  asBsdf_blend::aIncandescence;
MObject  asBsdf_blend::aOutColor;
MObject  asBsdf_blend::aOutTransparency;
MObject  asBsdf_blend::aNormalCamera;
MObject  asBsdf_blend::aNormalCameraX;
MObject  asBsdf_blend::aNormalCameraY;
MObject  asBsdf_blend::aNormalCameraZ;
MObject  asBsdf_blend::aLightData;
MObject  asBsdf_blend::aLightDirection;
MObject  asBsdf_blend::aLightDirectionX;
MObject  asBsdf_blend::aLightDirectionY;
MObject  asBsdf_blend::aLightDirectionZ;
MObject  asBsdf_blend::aLightIntensity;
MObject  asBsdf_blend::aLightIntensityR;
MObject  asBsdf_blend::aLightIntensityG;
MObject  asBsdf_blend::aLightIntensityB;
MObject  asBsdf_blend::aLightAmbient;
MObject  asBsdf_blend::aLightDiffuse;
MObject  asBsdf_blend::aLightSpecular;
MObject  asBsdf_blend::aLightShadowFraction;
MObject  asBsdf_blend::aPreShadowIntensity;
MObject  asBsdf_blend::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asBsdf_blend::bsdf0;
MObject asBsdf_blend::bsdf1;
MObject asBsdf_blend::weight;
...
// method.
//
// In this case creator simply returns a new asBsdf_blend object.
//

void* asBsdf_blend::creator()
{
    return new asBsdf_blend();
}
...
MStatus asBsdf_blend::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	weight = nAttr.create("weight", "weight",  MFnNumericData::kFloat, 0.5);
...
//
MStatus asBsdf_blend::compute( const MPlug& plug, MDataBlock& block )
{
