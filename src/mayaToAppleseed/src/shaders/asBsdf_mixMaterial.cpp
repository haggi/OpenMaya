...
//
void asBsdf_mix::postConstructor( )
{
...
//
MObject  asBsdf_mix::aTranslucenceCoeff;
MObject  asBsdf_mix::aDiffuseReflectivity;
MObject  asBsdf_mix::aInTransparency;
MObject  asBsdf_mix::aColor;
MObject  asBsdf_mix::aIncandescence;
MObject  asBsdf_mix::aOutColor;
MObject  asBsdf_mix::aOutTransparency;
MObject  asBsdf_mix::aNormalCamera;
MObject  asBsdf_mix::aNormalCameraX;
MObject  asBsdf_mix::aNormalCameraY;
MObject  asBsdf_mix::aNormalCameraZ;
MObject  asBsdf_mix::aLightData;
MObject  asBsdf_mix::aLightDirection;
MObject  asBsdf_mix::aLightDirectionX;
MObject  asBsdf_mix::aLightDirectionY;
MObject  asBsdf_mix::aLightDirectionZ;
MObject  asBsdf_mix::aLightIntensity;
MObject  asBsdf_mix::aLightIntensityR;
MObject  asBsdf_mix::aLightIntensityG;
MObject  asBsdf_mix::aLightIntensityB;
MObject  asBsdf_mix::aLightAmbient;
MObject  asBsdf_mix::aLightDiffuse;
MObject  asBsdf_mix::aLightSpecular;
MObject  asBsdf_mix::aLightShadowFraction;
MObject  asBsdf_mix::aPreShadowIntensity;
MObject  asBsdf_mix::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asBsdf_mix::bsdf0;
MObject asBsdf_mix::bsdf1;
MObject asBsdf_mix::weight1;
MObject asBsdf_mix::weight0;
...
// method.
//
// In this case creator simply returns a new asBsdf_mix object.
//

void* asBsdf_mix::creator()
{
    return new asBsdf_mix();
}
...
//---------------------------- automatically created attributes start ------------------------------------
	bsdf0 = mAttr.create("bsdf0", "bsdf0");
	CHECK_MSTATUS(addAttribute( bsdf0 ));

	bsdf1 = mAttr.create("bsdf1", "bsdf1");
	CHECK_MSTATUS(addAttribute( bsdf1 ));

	weight1 = nAttr.create("weight1", "weight1",  MFnNumericData::kFloat, 0.5);
	CHECK_MSTATUS(addAttribute( weight1 ));

	weight0 = nAttr.create("weight0", "weight0",  MFnNumericData::kFloat, 0.5);
	CHECK_MSTATUS(addAttribute( weight0 ));
...
//
MStatus asBsdf_mix::compute( const MPlug& plug, MDataBlock& block )
{
