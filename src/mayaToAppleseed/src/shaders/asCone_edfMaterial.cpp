...
//
MTypeId	asCone_edf::id( 0x0011CF82 );
...
//
void asCone_edf::postConstructor( )
{
...
//
MObject  asCone_edf::aTranslucenceCoeff;
MObject  asCone_edf::aDiffuseReflectivity;
MObject  asCone_edf::aInTransparency;
MObject  asCone_edf::aColor;
MObject  asCone_edf::aIncandescence;
MObject  asCone_edf::aOutColor;
MObject  asCone_edf::aOutTransparency;
MObject  asCone_edf::aNormalCamera;
MObject  asCone_edf::aNormalCameraX;
MObject  asCone_edf::aNormalCameraY;
MObject  asCone_edf::aNormalCameraZ;
MObject  asCone_edf::aLightData;
MObject  asCone_edf::aLightDirection;
MObject  asCone_edf::aLightDirectionX;
MObject  asCone_edf::aLightDirectionY;
MObject  asCone_edf::aLightDirectionZ;
MObject  asCone_edf::aLightIntensity;
MObject  asCone_edf::aLightIntensityR;
MObject  asCone_edf::aLightIntensityG;
MObject  asCone_edf::aLightIntensityB;
MObject  asCone_edf::aLightAmbient;
MObject  asCone_edf::aLightDiffuse;
MObject  asCone_edf::aLightSpecular;
MObject  asCone_edf::aLightShadowFraction;
MObject  asCone_edf::aPreShadowIntensity;
MObject  asCone_edf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asCone_edf::angle;
MObject asCone_edf::radiance;
MObject asCone_edf::cast_indirect_light;
MObject asCone_edf::importance_multiplier;
MObject asCone_edf::radiance_multiplier;
...
// method.
//
// In this case creator simply returns a new asCone_edf object.
//

void* asCone_edf::creator()
{
    return new asCone_edf();
}
...
//---------------------------- automatically created attributes start ------------------------------------
	angle = nAttr.create("angle", "angle",  MFnNumericData::kFloat, 90.0);
...
//
MStatus asCone_edf::compute( const MPlug& plug, MDataBlock& block )
{
