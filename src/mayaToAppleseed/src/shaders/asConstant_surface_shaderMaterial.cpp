#include "asConstant_surface_shaderMaterial.h"
...
//
MTypeId	asConstant_surface_shader::id( 0x0011CF48 );
...
//
void asConstant_surface_shader::postConstructor( )
{
...
//
MObject  asConstant_surface_shader::aTranslucenceCoeff;
MObject  asConstant_surface_shader::aDiffuseReflectivity;
MObject  asConstant_surface_shader::aInTransparency;
MObject  asConstant_surface_shader::aColor;
MObject  asConstant_surface_shader::aIncandescence;
MObject  asConstant_surface_shader::aOutColor;
MObject  asConstant_surface_shader::aOutTransparency;
MObject  asConstant_surface_shader::aNormalCamera;
MObject  asConstant_surface_shader::aNormalCameraX;
MObject  asConstant_surface_shader::aNormalCameraY;
MObject  asConstant_surface_shader::aNormalCameraZ;
MObject  asConstant_surface_shader::aLightData;
MObject  asConstant_surface_shader::aLightDirection;
MObject  asConstant_surface_shader::aLightDirectionX;
MObject  asConstant_surface_shader::aLightDirectionY;
MObject  asConstant_surface_shader::aLightDirectionZ;
MObject  asConstant_surface_shader::aLightIntensity;
MObject  asConstant_surface_shader::aLightIntensityR;
MObject  asConstant_surface_shader::aLightIntensityG;
MObject  asConstant_surface_shader::aLightIntensityB;
MObject  asConstant_surface_shader::aLightAmbient;
MObject  asConstant_surface_shader::aLightDiffuse;
MObject  asConstant_surface_shader::aLightSpecular;
MObject  asConstant_surface_shader::aLightShadowFraction;
MObject  asConstant_surface_shader::aPreShadowIntensity;
MObject  asConstant_surface_shader::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asConstant_surface_shader::color;
MObject asConstant_surface_shader::alpha_source;
MObject asConstant_surface_shader::color_multiplier;
MObject asConstant_surface_shader::alpha_multiplier;
...
asConstant_surface_shader::asConstant_surface_shader() { }
asConstant_surface_shader::~asConstant_surface_shader() { }
...
// method.
//
// In this case creator simply returns a new asConstant_surface_shader object.
//

void* asConstant_surface_shader::creator()
{
    return new asConstant_surface_shader();
}
...
MStatus asConstant_surface_shader::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	alpha_source = eAttr.create("alpha_source", "alpha_source", 0, &status);
	status = eAttr.addField( "color", 0 );
	status = eAttr.addField( "material", 1 );
	CHECK_MSTATUS(addAttribute( alpha_source ));
...
//
MStatus asConstant_surface_shader::compute( const MPlug& plug, MDataBlock& block )
{
