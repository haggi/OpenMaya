...
// Plugin asConstant_surface_shader Shader Class //
...
class asConstant_surface_shader : public MPxNode
{
public:
                    asConstant_surface_shader();
    virtual         ~asConstant_surface_shader();
