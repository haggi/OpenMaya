#include "asDiagnostic_surface_shaderMaterial.h"
...
//
MTypeId	asDiagnostic_surface_shader::id( 0x0011CF87 );
...
//
void asDiagnostic_surface_shader::postConstructor( )
{
...
//
MObject  asDiagnostic_surface_shader::aTranslucenceCoeff;
MObject  asDiagnostic_surface_shader::aDiffuseReflectivity;
MObject  asDiagnostic_surface_shader::aInTransparency;
MObject  asDiagnostic_surface_shader::aColor;
MObject  asDiagnostic_surface_shader::aIncandescence;
MObject  asDiagnostic_surface_shader::aOutColor;
MObject  asDiagnostic_surface_shader::aOutTransparency;
MObject  asDiagnostic_surface_shader::aNormalCamera;
MObject  asDiagnostic_surface_shader::aNormalCameraX;
MObject  asDiagnostic_surface_shader::aNormalCameraY;
MObject  asDiagnostic_surface_shader::aNormalCameraZ;
MObject  asDiagnostic_surface_shader::aLightData;
MObject  asDiagnostic_surface_shader::aLightDirection;
MObject  asDiagnostic_surface_shader::aLightDirectionX;
MObject  asDiagnostic_surface_shader::aLightDirectionY;
MObject  asDiagnostic_surface_shader::aLightDirectionZ;
MObject  asDiagnostic_surface_shader::aLightIntensity;
MObject  asDiagnostic_surface_shader::aLightIntensityR;
MObject  asDiagnostic_surface_shader::aLightIntensityG;
MObject  asDiagnostic_surface_shader::aLightIntensityB;
MObject  asDiagnostic_surface_shader::aLightAmbient;
MObject  asDiagnostic_surface_shader::aLightDiffuse;
MObject  asDiagnostic_surface_shader::aLightSpecular;
MObject  asDiagnostic_surface_shader::aLightShadowFraction;
MObject  asDiagnostic_surface_shader::aPreShadowIntensity;
MObject  asDiagnostic_surface_shader::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asDiagnostic_surface_shader::mode;
...
asDiagnostic_surface_shader::asDiagnostic_surface_shader() { }
asDiagnostic_surface_shader::~asDiagnostic_surface_shader() { }
...
// method.
//
// In this case creator simply returns a new asDiagnostic_surface_shader object.
//

void* asDiagnostic_surface_shader::creator()
{
    return new asDiagnostic_surface_shader();
}
...
MStatus asDiagnostic_surface_shader::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	mode = eAttr.create("mode", "mode", 4, &status);
	status = eAttr.addField( "ambient_occlusion", 0 );
	status = eAttr.addField( "assembly_instances", 1 );
	status = eAttr.addField( "barycentric", 2 );
	status = eAttr.addField( "bitangent", 3 );
	status = eAttr.addField( "coverage", 4 );
	status = eAttr.addField( "depth", 5 );
	status = eAttr.addField( "geometric_normal", 6 );
	status = eAttr.addField( "materials", 7 );
	status = eAttr.addField( "object_instances", 8 );
	status = eAttr.addField( "original_shading_normal", 9 );
	status = eAttr.addField( "regions", 10 );
	status = eAttr.addField( "shading_normal", 11 );
	status = eAttr.addField( "sides", 12 );
	status = eAttr.addField( "tangent", 13 );
	status = eAttr.addField( "triangles", 14 );
	status = eAttr.addField( "uv", 15 );
	status = eAttr.addField( "wireframe", 16 );
...
//
MStatus asDiagnostic_surface_shader::compute( const MPlug& plug, MDataBlock& block )
{
