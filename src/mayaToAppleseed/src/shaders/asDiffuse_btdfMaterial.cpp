#include "asDiffuse_btdfMaterial.h"
...
//
MTypeId	asDiffuse_btdf::id( 0x0011CF83 );
...
//
void asDiffuse_btdf::postConstructor( )
{
...
//
MObject  asDiffuse_btdf::aTranslucenceCoeff;
MObject  asDiffuse_btdf::aDiffuseReflectivity;
MObject  asDiffuse_btdf::aInTransparency;
MObject  asDiffuse_btdf::aColor;
MObject  asDiffuse_btdf::aIncandescence;
MObject  asDiffuse_btdf::aOutColor;
MObject  asDiffuse_btdf::aOutTransparency;
MObject  asDiffuse_btdf::aNormalCamera;
MObject  asDiffuse_btdf::aNormalCameraX;
MObject  asDiffuse_btdf::aNormalCameraY;
MObject  asDiffuse_btdf::aNormalCameraZ;
MObject  asDiffuse_btdf::aLightData;
MObject  asDiffuse_btdf::aLightDirection;
MObject  asDiffuse_btdf::aLightDirectionX;
MObject  asDiffuse_btdf::aLightDirectionY;
MObject  asDiffuse_btdf::aLightDirectionZ;
MObject  asDiffuse_btdf::aLightIntensity;
MObject  asDiffuse_btdf::aLightIntensityR;
MObject  asDiffuse_btdf::aLightIntensityG;
MObject  asDiffuse_btdf::aLightIntensityB;
MObject  asDiffuse_btdf::aLightAmbient;
MObject  asDiffuse_btdf::aLightDiffuse;
MObject  asDiffuse_btdf::aLightSpecular;
MObject  asDiffuse_btdf::aLightShadowFraction;
MObject  asDiffuse_btdf::aPreShadowIntensity;
MObject  asDiffuse_btdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asDiffuse_btdf::transmittance;
MObject asDiffuse_btdf::transmittance_multiplier;
...
// method.
//
// In this case creator simply returns a new asDiffuse_btdf object.
//

void* asDiffuse_btdf::creator()
{
    return new asDiffuse_btdf();
}
...
MStatus asDiffuse_btdf::initialize()
{
...
//
MStatus asDiffuse_btdf::compute( const MPlug& plug, MDataBlock& block )
{
