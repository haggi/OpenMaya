#include "asDiffuse_edfMaterial.h"
...
//
MTypeId	asDiffuse_edf::id( 0x0011CF8A );
...
//
void asDiffuse_edf::postConstructor( )
{
...
//
MObject  asDiffuse_edf::aTranslucenceCoeff;
MObject  asDiffuse_edf::aDiffuseReflectivity;
MObject  asDiffuse_edf::aInTransparency;
MObject  asDiffuse_edf::aColor;
MObject  asDiffuse_edf::aIncandescence;
MObject  asDiffuse_edf::aOutColor;
MObject  asDiffuse_edf::aOutTransparency;
MObject  asDiffuse_edf::aNormalCamera;
MObject  asDiffuse_edf::aNormalCameraX;
MObject  asDiffuse_edf::aNormalCameraY;
MObject  asDiffuse_edf::aNormalCameraZ;
MObject  asDiffuse_edf::aLightData;
MObject  asDiffuse_edf::aLightDirection;
MObject  asDiffuse_edf::aLightDirectionX;
MObject  asDiffuse_edf::aLightDirectionY;
MObject  asDiffuse_edf::aLightDirectionZ;
MObject  asDiffuse_edf::aLightIntensity;
MObject  asDiffuse_edf::aLightIntensityR;
MObject  asDiffuse_edf::aLightIntensityG;
MObject  asDiffuse_edf::aLightIntensityB;
MObject  asDiffuse_edf::aLightAmbient;
MObject  asDiffuse_edf::aLightDiffuse;
MObject  asDiffuse_edf::aLightSpecular;
MObject  asDiffuse_edf::aLightShadowFraction;
MObject  asDiffuse_edf::aPreShadowIntensity;
MObject  asDiffuse_edf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asDiffuse_edf::radiance_multiplier;
MObject asDiffuse_edf::radiance;
MObject asDiffuse_edf::cast_indirect_light;
MObject asDiffuse_edf::importance_multiplier;
...
// method.
//
// In this case creator simply returns a new asDiffuse_edf object.
//

void* asDiffuse_edf::creator()
{
    return new asDiffuse_edf();
}
...
MStatus asDiffuse_edf::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	radiance = nAttr.createColor("radiance", "radiance");
	nAttr.setDefault(1.0,1.0,1.0);
	CHECK_MSTATUS(addAttribute( radiance ));
...
//
MStatus asDiffuse_edf::compute( const MPlug& plug, MDataBlock& block )
{
