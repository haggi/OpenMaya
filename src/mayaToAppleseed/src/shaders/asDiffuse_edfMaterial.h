...
// Plugin asDiffuse_edf Shader Class //
...
class asDiffuse_edf : public MPxNode
{
public:
                    asDiffuse_edf();
    virtual         ~asDiffuse_edf();
...
//---------------------------- automatically created attributes start ------------------------------------
	static    MObject radiance_multiplier;
	static    MObject radiance;
	static    MObject cast_indirect_light;
	static    MObject importance_multiplier;
