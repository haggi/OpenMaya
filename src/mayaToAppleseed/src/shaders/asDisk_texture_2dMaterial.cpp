#include "asDisk_texture_2dMaterial.h"
...
//
MTypeId	asDisk_texture_2d::id( 0x0011CF7D );
...
//
void asDisk_texture_2d::postConstructor( )
{
...
//
MObject  asDisk_texture_2d::aTranslucenceCoeff;
MObject  asDisk_texture_2d::aDiffuseReflectivity;
MObject  asDisk_texture_2d::aInTransparency;
MObject  asDisk_texture_2d::aColor;
MObject  asDisk_texture_2d::aIncandescence;
MObject  asDisk_texture_2d::aOutColor;
MObject  asDisk_texture_2d::aOutTransparency;
MObject  asDisk_texture_2d::aNormalCamera;
MObject  asDisk_texture_2d::aNormalCameraX;
MObject  asDisk_texture_2d::aNormalCameraY;
MObject  asDisk_texture_2d::aNormalCameraZ;
MObject  asDisk_texture_2d::aLightData;
MObject  asDisk_texture_2d::aLightDirection;
MObject  asDisk_texture_2d::aLightDirectionX;
MObject  asDisk_texture_2d::aLightDirectionY;
MObject  asDisk_texture_2d::aLightDirectionZ;
MObject  asDisk_texture_2d::aLightIntensity;
MObject  asDisk_texture_2d::aLightIntensityR;
MObject  asDisk_texture_2d::aLightIntensityG;
MObject  asDisk_texture_2d::aLightIntensityB;
MObject  asDisk_texture_2d::aLightAmbient;
MObject  asDisk_texture_2d::aLightDiffuse;
MObject  asDisk_texture_2d::aLightSpecular;
MObject  asDisk_texture_2d::aLightShadowFraction;
MObject  asDisk_texture_2d::aPreShadowIntensity;
MObject  asDisk_texture_2d::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asDisk_texture_2d::color_space;
MObject asDisk_texture_2d::filename;
...
asDisk_texture_2d::asDisk_texture_2d() { }
asDisk_texture_2d::~asDisk_texture_2d() { }
...
// method.
//
// In this case creator simply returns a new asDisk_texture_2d object.
//

void* asDisk_texture_2d::creator()
{
    return new asDisk_texture_2d();
}
...
MStatus asDisk_texture_2d::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	color_space = eAttr.create("color_space", "color_space", 2, &status);
	status = eAttr.addField( "ciexyz", 0 );
	status = eAttr.addField( "linear_rgb", 1 );
	status = eAttr.addField( "srgb", 2 );
	CHECK_MSTATUS(addAttribute( color_space ));
...
//
MStatus asDisk_texture_2d::compute( const MPlug& plug, MDataBlock& block )
{
