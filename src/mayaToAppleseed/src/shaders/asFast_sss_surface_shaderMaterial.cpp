#include "asFast_sss_surface_shaderMaterial.h"
...
//
void asFast_sss_surface_shader::postConstructor( )
{
...
//
MObject  asFast_sss_surface_shader::aTranslucenceCoeff;
MObject  asFast_sss_surface_shader::aDiffuseReflectivity;
MObject  asFast_sss_surface_shader::aInTransparency;
MObject  asFast_sss_surface_shader::aColor;
MObject  asFast_sss_surface_shader::aIncandescence;
MObject  asFast_sss_surface_shader::aOutColor;
MObject  asFast_sss_surface_shader::aOutTransparency;
MObject  asFast_sss_surface_shader::aNormalCamera;
MObject  asFast_sss_surface_shader::aNormalCameraX;
MObject  asFast_sss_surface_shader::aNormalCameraY;
MObject  asFast_sss_surface_shader::aNormalCameraZ;
MObject  asFast_sss_surface_shader::aLightData;
MObject  asFast_sss_surface_shader::aLightDirection;
MObject  asFast_sss_surface_shader::aLightDirectionX;
MObject  asFast_sss_surface_shader::aLightDirectionY;
MObject  asFast_sss_surface_shader::aLightDirectionZ;
MObject  asFast_sss_surface_shader::aLightIntensity;
MObject  asFast_sss_surface_shader::aLightIntensityR;
MObject  asFast_sss_surface_shader::aLightIntensityG;
MObject  asFast_sss_surface_shader::aLightIntensityB;
MObject  asFast_sss_surface_shader::aLightAmbient;
MObject  asFast_sss_surface_shader::aLightDiffuse;
MObject  asFast_sss_surface_shader::aLightSpecular;
MObject  asFast_sss_surface_shader::aLightShadowFraction;
MObject  asFast_sss_surface_shader::aPreShadowIntensity;
MObject  asFast_sss_surface_shader::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asFast_sss_surface_shader::ambient_sss;
MObject asFast_sss_surface_shader::light_samples;
MObject asFast_sss_surface_shader::power;
MObject asFast_sss_surface_shader::view_dep_sss;
MObject asFast_sss_surface_shader::distortion;
MObject asFast_sss_surface_shader::scale;
MObject asFast_sss_surface_shader::diffuse;
MObject asFast_sss_surface_shader::occlusion_samples;
MObject asFast_sss_surface_shader::albedo;
...
asFast_sss_surface_shader::asFast_sss_surface_shader() { }
asFast_sss_surface_shader::~asFast_sss_surface_shader() { }
...
// method.
//
// In this case creator simply returns a new asFast_sss_surface_shader object.
//

void* asFast_sss_surface_shader::creator()
{
    return new asFast_sss_surface_shader();
}
...
MStatus asFast_sss_surface_shader::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	ambient_sss = nAttr.create("ambient_sss", "ambient_sss",  MFnNumericData::kFloat, 0.0);
	...
	power = nAttr.create("power", "power",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( power ));

	view_dep_sss = nAttr.create("view_dep_sss", "view_dep_sss",  MFnNumericData::kFloat, 0.0);
	CHECK_MSTATUS(addAttribute( view_dep_sss ));

	distortion = nAttr.create("distortion", "distortion",  MFnNumericData::kFloat, 0.0);
	CHECK_MSTATUS(addAttribute( distortion ));

	scale = nAttr.create("scale", "scale",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( scale ));

	diffuse = nAttr.create("diffuse", "diffuse",  MFnNumericData::kFloat, 0.0);
...
//
MStatus asFast_sss_surface_shader::compute( const MPlug& plug, MDataBlock& block )
{
