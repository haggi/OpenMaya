#include "asKelemen_brdfMaterial.h"
...
//
MTypeId	asKelemen_brdf::id( 0x0011CF8C );
...
//
void asKelemen_brdf::postConstructor( )
{
...
//
MObject  asKelemen_brdf::aTranslucenceCoeff;
MObject  asKelemen_brdf::aDiffuseReflectivity;
MObject  asKelemen_brdf::aInTransparency;
MObject  asKelemen_brdf::aColor;
MObject  asKelemen_brdf::aIncandescence;
MObject  asKelemen_brdf::aOutColor;
MObject  asKelemen_brdf::aOutTransparency;
MObject  asKelemen_brdf::aNormalCamera;
MObject  asKelemen_brdf::aNormalCameraX;
MObject  asKelemen_brdf::aNormalCameraY;
MObject  asKelemen_brdf::aNormalCameraZ;
MObject  asKelemen_brdf::aLightData;
MObject  asKelemen_brdf::aLightDirection;
MObject  asKelemen_brdf::aLightDirectionX;
MObject  asKelemen_brdf::aLightDirectionY;
MObject  asKelemen_brdf::aLightDirectionZ;
MObject  asKelemen_brdf::aLightIntensity;
MObject  asKelemen_brdf::aLightIntensityR;
MObject  asKelemen_brdf::aLightIntensityG;
MObject  asKelemen_brdf::aLightIntensityB;
MObject  asKelemen_brdf::aLightAmbient;
MObject  asKelemen_brdf::aLightDiffuse;
MObject  asKelemen_brdf::aLightSpecular;
MObject  asKelemen_brdf::aLightShadowFraction;
MObject  asKelemen_brdf::aPreShadowIntensity;
MObject  asKelemen_brdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asKelemen_brdf::matte_reflectance_multiplier;
MObject asKelemen_brdf::specular_reflectance_multiplier;
MObject asKelemen_brdf::specular_reflectance;
MObject asKelemen_brdf::matte_reflectance;
MObject asKelemen_brdf::roughness;
...
// method.
//
// In this case creator simply returns a new asKelemen_brdf object.
//

void* asKelemen_brdf::creator()
{
    return new asKelemen_brdf();
}
...
MStatus asKelemen_brdf::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	matte_reflectance_multiplier = nAttr.create("matte_reflectance_multiplier", "matte_reflectance_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( matte_reflectance_multiplier ));

	specular_reflectance_multiplier = nAttr.create("specular_reflectance_multiplier", "specular_reflectance_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( specular_reflectance_multiplier ));

	specular_reflectance = nAttr.createColor("specular_reflectance", "specular_reflectance");
	nAttr.setDefault(0.5,0.5,0.5);
	CHECK_MSTATUS(addAttribute( specular_reflectance ));

	matte_reflectance = nAttr.createColor("matte_reflectance", "matte_reflectance");
	nAttr.setDefault(0.5,0.5,0.5);
	CHECK_MSTATUS(addAttribute( matte_reflectance ));
...
//
MStatus asKelemen_brdf::compute( const MPlug& plug, MDataBlock& block )
{
