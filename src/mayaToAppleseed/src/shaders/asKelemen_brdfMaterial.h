...
// Plugin asKelemen_brdf Shader Class //
...
class asKelemen_brdf : public MPxNode
{
public:
                    asKelemen_brdf();
    virtual         ~asKelemen_brdf();
...
//---------------------------- automatically created attributes start ------------------------------------
	static    MObject matte_reflectance_multiplier;
	static    MObject specular_reflectance_multiplier;
	static    MObject specular_reflectance;
	static    MObject matte_reflectance;
