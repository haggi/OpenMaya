#include "asLambertian_brdfMaterial.h"
...
//
MTypeId	asLambertian_brdf::id( 0x0011CF7F );
...
//
void asLambertian_brdf::postConstructor( )
{
...
//
MObject  asLambertian_brdf::aTranslucenceCoeff;
MObject  asLambertian_brdf::aDiffuseReflectivity;
MObject  asLambertian_brdf::aInTransparency;
MObject  asLambertian_brdf::aColor;
MObject  asLambertian_brdf::aIncandescence;
MObject  asLambertian_brdf::aOutColor;
MObject  asLambertian_brdf::aOutTransparency;
MObject  asLambertian_brdf::aNormalCamera;
MObject  asLambertian_brdf::aNormalCameraX;
MObject  asLambertian_brdf::aNormalCameraY;
MObject  asLambertian_brdf::aNormalCameraZ;
MObject  asLambertian_brdf::aLightData;
MObject  asLambertian_brdf::aLightDirection;
MObject  asLambertian_brdf::aLightDirectionX;
MObject  asLambertian_brdf::aLightDirectionY;
MObject  asLambertian_brdf::aLightDirectionZ;
MObject  asLambertian_brdf::aLightIntensity;
MObject  asLambertian_brdf::aLightIntensityR;
MObject  asLambertian_brdf::aLightIntensityG;
MObject  asLambertian_brdf::aLightIntensityB;
MObject  asLambertian_brdf::aLightAmbient;
MObject  asLambertian_brdf::aLightDiffuse;
MObject  asLambertian_brdf::aLightSpecular;
MObject  asLambertian_brdf::aLightShadowFraction;
MObject  asLambertian_brdf::aPreShadowIntensity;
MObject  asLambertian_brdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asLambertian_brdf::reflectance;
MObject asLambertian_brdf::reflectance_multiplier;
...
asLambertian_brdf::asLambertian_brdf() { }
asLambertian_brdf::~asLambertian_brdf() { }
...
// method.
//
// In this case creator simply returns a new asLambertian_brdf object.
//

void* asLambertian_brdf::creator()
{
    return new asLambertian_brdf();
}
...
MStatus asLambertian_brdf::initialize()
{
...
//
MStatus asLambertian_brdf::compute( const MPlug& plug, MDataBlock& block )
{
