...
//
MTypeId	asMaterial::id( 0x0011CF8B );
...
//
void asMaterial::postConstructor( )
{
...
//
MObject  asMaterial::aTranslucenceCoeff;
MObject  asMaterial::aDiffuseReflectivity;
MObject  asMaterial::aInTransparency;
MObject  asMaterial::aColor;
MObject  asMaterial::aIncandescence;
MObject  asMaterial::aOutColor;
MObject  asMaterial::aOutTransparency;
MObject  asMaterial::aNormalCamera;
MObject  asMaterial::aNormalCameraX;
MObject  asMaterial::aNormalCameraY;
MObject  asMaterial::aNormalCameraZ;
MObject  asMaterial::aLightData;
MObject  asMaterial::aLightDirection;
MObject  asMaterial::aLightDirectionX;
MObject  asMaterial::aLightDirectionY;
MObject  asMaterial::aLightDirectionZ;
MObject  asMaterial::aLightIntensity;
MObject  asMaterial::aLightIntensityR;
MObject  asMaterial::aLightIntensityG;
MObject  asMaterial::aLightIntensityB;
MObject  asMaterial::aLightAmbient;
MObject  asMaterial::aLightDiffuse;
MObject  asMaterial::aLightSpecular;
MObject  asMaterial::aLightShadowFraction;
MObject  asMaterial::aPreShadowIntensity;
MObject  asMaterial::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asMaterial::surface_shader;
MObject asMaterial::bsdf;
MObject asMaterial::edf;
MObject asMaterial::alpha_map;
MObject asMaterial::normal_map;
...
// method.
//
// In this case creator simply returns a new asMaterial object.
//

void* asMaterial::creator()
{
    return new asMaterial();
}
...
//---------------------------- automatically created attributes start ------------------------------------
	surface_shader = mAttr.create("surface_shader", "surface_shader");
	CHECK_MSTATUS(addAttribute( surface_shader ));

	bsdf = mAttr.create("bsdf", "bsdf");
	CHECK_MSTATUS(addAttribute( bsdf ));

	edf = mAttr.create("edf", "edf");
	CHECK_MSTATUS(addAttribute( edf ));

	alpha_map = nAttr.createColor("alpha_map", "alpha_map");
	nAttr.setDefault(0.0,0.0,0.0);
	CHECK_MSTATUS(addAttribute( alpha_map ));

	normal_map = nAttr.createColor("normal_map", "normal_map");
	nAttr.setDefault(0.0,0.0,0.0);
	CHECK_MSTATUS(addAttribute( normal_map ));
...
//
MStatus asMaterial::compute( const MPlug& plug, MDataBlock& block )
{
