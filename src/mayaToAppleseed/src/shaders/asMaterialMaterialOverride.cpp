...
#include "asMaterialOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* asMaterialOverride::creator(const MObject& obj)
{
	return new asMaterialOverride(obj);
}

asMaterialOverride::asMaterialOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

asMaterialOverride::~asMaterialOverride()
{
}

MHWRender::DrawAPI asMaterialOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString asMaterialOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void asMaterialOverride::getCustomMappings(
...
MString asMaterialOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString asMaterialOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString asMaterialOverride::bumpAttribute() const
{
