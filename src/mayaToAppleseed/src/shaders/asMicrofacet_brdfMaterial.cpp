#include "asMicrofacet_brdfMaterial.h"
...
//
MTypeId	asMicrofacet_brdf::id( 0x0011CF84 );
...
//
MObject  asMicrofacet_brdf::aTranslucenceCoeff;
MObject  asMicrofacet_brdf::aDiffuseReflectivity;
MObject  asMicrofacet_brdf::aInTransparency;
MObject  asMicrofacet_brdf::aColor;
MObject  asMicrofacet_brdf::aIncandescence;
MObject  asMicrofacet_brdf::aOutColor;
MObject  asMicrofacet_brdf::aOutTransparency;
MObject  asMicrofacet_brdf::aNormalCamera;
MObject  asMicrofacet_brdf::aNormalCameraX;
MObject  asMicrofacet_brdf::aNormalCameraY;
MObject  asMicrofacet_brdf::aNormalCameraZ;
MObject  asMicrofacet_brdf::aLightData;
MObject  asMicrofacet_brdf::aLightDirection;
MObject  asMicrofacet_brdf::aLightDirectionX;
MObject  asMicrofacet_brdf::aLightDirectionY;
MObject  asMicrofacet_brdf::aLightDirectionZ;
MObject  asMicrofacet_brdf::aLightIntensity;
MObject  asMicrofacet_brdf::aLightIntensityR;
MObject  asMicrofacet_brdf::aLightIntensityG;
MObject  asMicrofacet_brdf::aLightIntensityB;
MObject  asMicrofacet_brdf::aLightAmbient;
MObject  asMicrofacet_brdf::aLightDiffuse;
MObject  asMicrofacet_brdf::aLightSpecular;
MObject  asMicrofacet_brdf::aLightShadowFraction;
MObject  asMicrofacet_brdf::aPreShadowIntensity;
MObject  asMicrofacet_brdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asMicrofacet_brdf::reflectance;
MObject asMicrofacet_brdf::mdf;
MObject asMicrofacet_brdf::glossiness_multiplier;
MObject asMicrofacet_brdf::glossiness;
MObject asMicrofacet_brdf::fresnel_multiplier;
MObject asMicrofacet_brdf::reflectance_multiplier;
...
asMicrofacet_brdf::asMicrofacet_brdf() { }
asMicrofacet_brdf::~asMicrofacet_brdf() { }
...
// method.
//
// In this case creator simply returns a new asMicrofacet_brdf object.
//

void* asMicrofacet_brdf::creator()
{
    return new asMicrofacet_brdf();
}
