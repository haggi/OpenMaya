#include "asPhysical_surface_shaderMaterial.h"
...
//
void asPhysical_surface_shader::postConstructor( )
{
...
//
MObject  asPhysical_surface_shader::aTranslucenceCoeff;
MObject  asPhysical_surface_shader::aDiffuseReflectivity;
MObject  asPhysical_surface_shader::aInTransparency;
MObject  asPhysical_surface_shader::aColor;
MObject  asPhysical_surface_shader::aIncandescence;
MObject  asPhysical_surface_shader::aOutColor;
MObject  asPhysical_surface_shader::aOutTransparency;
MObject  asPhysical_surface_shader::aNormalCamera;
MObject  asPhysical_surface_shader::aNormalCameraX;
MObject  asPhysical_surface_shader::aNormalCameraY;
MObject  asPhysical_surface_shader::aNormalCameraZ;
MObject  asPhysical_surface_shader::aLightData;
MObject  asPhysical_surface_shader::aLightDirection;
MObject  asPhysical_surface_shader::aLightDirectionX;
MObject  asPhysical_surface_shader::aLightDirectionY;
MObject  asPhysical_surface_shader::aLightDirectionZ;
MObject  asPhysical_surface_shader::aLightIntensity;
MObject  asPhysical_surface_shader::aLightIntensityR;
MObject  asPhysical_surface_shader::aLightIntensityG;
MObject  asPhysical_surface_shader::aLightIntensityB;
MObject  asPhysical_surface_shader::aLightAmbient;
MObject  asPhysical_surface_shader::aLightDiffuse;
MObject  asPhysical_surface_shader::aLightSpecular;
MObject  asPhysical_surface_shader::aLightShadowFraction;
MObject  asPhysical_surface_shader::aPreShadowIntensity;
MObject  asPhysical_surface_shader::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asPhysical_surface_shader::back_lighting_samples;
MObject asPhysical_surface_shader::front_lighting_samples;
MObject asPhysical_surface_shader::aerial_persp_sky_color;
MObject asPhysical_surface_shader::aerial_persp_mode;
MObject asPhysical_surface_shader::aerial_persp_distance;
MObject asPhysical_surface_shader::aerial_persp_intensity;
MObject asPhysical_surface_shader::translucency;
MObject asPhysical_surface_shader::color_multiplier;
MObject asPhysical_surface_shader::alpha_multiplier;
...
asPhysical_surface_shader::asPhysical_surface_shader() { }
asPhysical_surface_shader::~asPhysical_surface_shader() { }
...
// method.
//
// In this case creator simply returns a new asPhysical_surface_shader object.
//

void* asPhysical_surface_shader::creator()
{
    return new asPhysical_surface_shader();
}
...
MStatus asPhysical_surface_shader::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	aerial_persp_sky_color = nAttr.createColor("aerial_persp_sky_color", "aerial_persp_sky_color");
	nAttr.setDefault(0.5,0.5,0.5);
	CHECK_MSTATUS(addAttribute( aerial_persp_sky_color ));

	aerial_persp_mode = eAttr.create("aerial_persp_mode", "aerial_persp_mode", 0, &status);
	status = eAttr.addField( "none", 0 );
	status = eAttr.addField( "environment_shader", 1 );
	status = eAttr.addField( "sky_color", 2 );
	CHECK_MSTATUS(addAttribute( aerial_persp_mode ));

	aerial_persp_distance = nAttr.create("aerial_persp_distance", "aerial_persp_distance",  MFnNumericData::kFloat, 1000.0);
	CHECK_MSTATUS(addAttribute( aerial_persp_distance ));

	aerial_persp_intensity = nAttr.create("aerial_persp_intensity", "aerial_persp_intensity",  MFnNumericData::kFloat, 0.01);
	CHECK_MSTATUS(addAttribute( aerial_persp_intensity ));

	translucency = nAttr.create("translucency", "translucency",  MFnNumericData::kFloat, 0.0);
	CHECK_MSTATUS(addAttribute( translucency ));

	color_multiplier = nAttr.create("color_multiplier", "color_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( color_multiplier ));

	alpha_multiplier = nAttr.create("alpha_multiplier", "alpha_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( alpha_multiplier ));
...
//
MStatus asPhysical_surface_shader::compute( const MPlug& plug, MDataBlock& block )
{
