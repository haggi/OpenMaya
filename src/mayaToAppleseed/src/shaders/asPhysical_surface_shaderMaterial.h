...
// Plugin asPhysical_surface_shader Shader Class //
...
class asPhysical_surface_shader : public MPxNode
{
public:
                    asPhysical_surface_shader();
    virtual         ~asPhysical_surface_shader();
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	static    MObject aerial_persp_sky_color;
	static    MObject aerial_persp_mode;
	static    MObject aerial_persp_distance;
	static    MObject aerial_persp_intensity;
	static    MObject translucency;
	static    MObject color_multiplier;
	static    MObject alpha_multiplier;
