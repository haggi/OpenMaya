#include "asSpecular_brdfMaterial.h"
...
//
MTypeId	asSpecular_brdf::id( 0x0011CF53 );
...
//
void asSpecular_brdf::postConstructor( )
{
...
//
MObject  asSpecular_brdf::aTranslucenceCoeff;
MObject  asSpecular_brdf::aDiffuseReflectivity;
MObject  asSpecular_brdf::aInTransparency;
MObject  asSpecular_brdf::aColor;
MObject  asSpecular_brdf::aIncandescence;
MObject  asSpecular_brdf::aOutColor;
MObject  asSpecular_brdf::aOutTransparency;
MObject  asSpecular_brdf::aNormalCamera;
MObject  asSpecular_brdf::aNormalCameraX;
MObject  asSpecular_brdf::aNormalCameraY;
MObject  asSpecular_brdf::aNormalCameraZ;
MObject  asSpecular_brdf::aLightData;
MObject  asSpecular_brdf::aLightDirection;
MObject  asSpecular_brdf::aLightDirectionX;
MObject  asSpecular_brdf::aLightDirectionY;
MObject  asSpecular_brdf::aLightDirectionZ;
MObject  asSpecular_brdf::aLightIntensity;
MObject  asSpecular_brdf::aLightIntensityR;
MObject  asSpecular_brdf::aLightIntensityG;
MObject  asSpecular_brdf::aLightIntensityB;
MObject  asSpecular_brdf::aLightAmbient;
MObject  asSpecular_brdf::aLightDiffuse;
MObject  asSpecular_brdf::aLightSpecular;
MObject  asSpecular_brdf::aLightShadowFraction;
MObject  asSpecular_brdf::aPreShadowIntensity;
MObject  asSpecular_brdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asSpecular_brdf::reflectance;
MObject asSpecular_brdf::reflectance_multiplier;
...
asSpecular_brdf::asSpecular_brdf() { }
asSpecular_brdf::~asSpecular_brdf() { }
...
// method.
//
// In this case creator simply returns a new asSpecular_brdf object.
//

void* asSpecular_brdf::creator()
{
    return new asSpecular_brdf();
}
...
MStatus asSpecular_brdf::initialize()
{
...
//
MStatus asSpecular_brdf::compute( const MPlug& plug, MDataBlock& block )
{
