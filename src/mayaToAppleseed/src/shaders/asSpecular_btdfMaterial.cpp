#include "asSpecular_btdfMaterial.h"
...
//
void asSpecular_btdf::postConstructor( )
{
...
//
MObject  asSpecular_btdf::aTranslucenceCoeff;
MObject  asSpecular_btdf::aDiffuseReflectivity;
MObject  asSpecular_btdf::aInTransparency;
MObject  asSpecular_btdf::aColor;
MObject  asSpecular_btdf::aIncandescence;
MObject  asSpecular_btdf::aOutColor;
MObject  asSpecular_btdf::aOutTransparency;
MObject  asSpecular_btdf::aNormalCamera;
MObject  asSpecular_btdf::aNormalCameraX;
MObject  asSpecular_btdf::aNormalCameraY;
MObject  asSpecular_btdf::aNormalCameraZ;
MObject  asSpecular_btdf::aLightData;
MObject  asSpecular_btdf::aLightDirection;
MObject  asSpecular_btdf::aLightDirectionX;
MObject  asSpecular_btdf::aLightDirectionY;
MObject  asSpecular_btdf::aLightDirectionZ;
MObject  asSpecular_btdf::aLightIntensity;
MObject  asSpecular_btdf::aLightIntensityR;
MObject  asSpecular_btdf::aLightIntensityG;
MObject  asSpecular_btdf::aLightIntensityB;
MObject  asSpecular_btdf::aLightAmbient;
MObject  asSpecular_btdf::aLightDiffuse;
MObject  asSpecular_btdf::aLightSpecular;
MObject  asSpecular_btdf::aLightShadowFraction;
MObject  asSpecular_btdf::aPreShadowIntensity;
MObject  asSpecular_btdf::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asSpecular_btdf::transmittance;
MObject asSpecular_btdf::reflectance;
MObject asSpecular_btdf::from_ior;
MObject asSpecular_btdf::to_ior;
MObject asSpecular_btdf::transmittance_multiplier;
MObject asSpecular_btdf::reflectance_multiplier;
...
asSpecular_btdf::asSpecular_btdf() { }
asSpecular_btdf::~asSpecular_btdf() { }
...
// method.
//
// In this case creator simply returns a new asSpecular_btdf object.
//

void* asSpecular_btdf::creator()
{
    return new asSpecular_btdf();
}
...
MStatus asSpecular_btdf::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	from_ior = nAttr.create("from_ior", "from_ior",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( from_ior ));

	to_ior = nAttr.create("to_ior", "to_ior",  MFnNumericData::kFloat, 1.5);
	CHECK_MSTATUS(addAttribute( to_ior ));

	transmittance_multiplier = nAttr.create("transmittance_multiplier", "transmittance_multiplier",  MFnNumericData::kFloat, 1.0);
	CHECK_MSTATUS(addAttribute( transmittance_multiplier ));
...
//
MStatus asSpecular_btdf::compute( const MPlug& plug, MDataBlock& block )
{
