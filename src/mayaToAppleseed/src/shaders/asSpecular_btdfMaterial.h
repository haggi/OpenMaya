...
// Plugin asSpecular_btdf Shader Class //
...
class asSpecular_btdf : public MPxNode
{
public:
                    asSpecular_btdf();
    virtual         ~asSpecular_btdf();
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	static    MObject reflectance;
	static    MObject from_ior;
	static    MObject to_ior;
	static    MObject transmittance_multiplier;
	static    MObject reflectance_multiplier;
