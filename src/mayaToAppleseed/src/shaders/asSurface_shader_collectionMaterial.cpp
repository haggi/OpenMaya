#include "asSurface_shader_collectionMaterial.h"
...
//
MTypeId	asSurface_shader_collection::id( 0x0011CF55 );
...
//
void asSurface_shader_collection::postConstructor( )
{
...
//
MObject  asSurface_shader_collection::aTranslucenceCoeff;
MObject  asSurface_shader_collection::aDiffuseReflectivity;
MObject  asSurface_shader_collection::aInTransparency;
MObject  asSurface_shader_collection::aColor;
MObject  asSurface_shader_collection::aIncandescence;
MObject  asSurface_shader_collection::aOutColor;
MObject  asSurface_shader_collection::aOutTransparency;
MObject  asSurface_shader_collection::aNormalCamera;
MObject  asSurface_shader_collection::aNormalCameraX;
MObject  asSurface_shader_collection::aNormalCameraY;
MObject  asSurface_shader_collection::aNormalCameraZ;
MObject  asSurface_shader_collection::aLightData;
MObject  asSurface_shader_collection::aLightDirection;
MObject  asSurface_shader_collection::aLightDirectionX;
MObject  asSurface_shader_collection::aLightDirectionY;
MObject  asSurface_shader_collection::aLightDirectionZ;
MObject  asSurface_shader_collection::aLightIntensity;
MObject  asSurface_shader_collection::aLightIntensityR;
MObject  asSurface_shader_collection::aLightIntensityG;
MObject  asSurface_shader_collection::aLightIntensityB;
MObject  asSurface_shader_collection::aLightAmbient;
MObject  asSurface_shader_collection::aLightDiffuse;
MObject  asSurface_shader_collection::aLightSpecular;
MObject  asSurface_shader_collection::aLightShadowFraction;
MObject  asSurface_shader_collection::aPreShadowIntensity;
MObject  asSurface_shader_collection::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject asSurface_shader_collection::surface_shader2;
MObject asSurface_shader_collection::surface_shader3;
MObject asSurface_shader_collection::surface_shader1;
MObject asSurface_shader_collection::surface_shader6;
MObject asSurface_shader_collection::surface_shader7;
MObject asSurface_shader_collection::surface_shader4;
MObject asSurface_shader_collection::surface_shader5;
MObject asSurface_shader_collection::surface_shader8;
...
asSurface_shader_collection::asSurface_shader_collection() { }
asSurface_shader_collection::~asSurface_shader_collection() { }
...
// method.
//
// In this case creator simply returns a new asSurface_shader_collection object.
//

void* asSurface_shader_collection::creator()
{
    return new asSurface_shader_collection();
}
...
MStatus asSurface_shader_collection::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	surface_shader2 = mAttr.create("surface_shader2", "surface_shader2");
	CHECK_MSTATUS(addAttribute( surface_shader2 ));

	surface_shader3 = mAttr.create("surface_shader3", "surface_shader3");
	CHECK_MSTATUS(addAttribute( surface_shader3 ));

	surface_shader1 = mAttr.create("surface_shader1", "surface_shader1");
	CHECK_MSTATUS(addAttribute( surface_shader1 ));

	surface_shader6 = mAttr.create("surface_shader6", "surface_shader6");
	CHECK_MSTATUS(addAttribute( surface_shader6 ));

	surface_shader7 = mAttr.create("surface_shader7", "surface_shader7");
	CHECK_MSTATUS(addAttribute( surface_shader7 ));

	surface_shader4 = mAttr.create("surface_shader4", "surface_shader4");
	CHECK_MSTATUS(addAttribute( surface_shader4 ));

	surface_shader5 = mAttr.create("surface_shader5", "surface_shader5");
	CHECK_MSTATUS(addAttribute( surface_shader5 ));

	surface_shader8 = mAttr.create("surface_shader8", "surface_shader8");
	CHECK_MSTATUS(addAttribute( surface_shader8 ));
...
//
MStatus asSurface_shader_collection::compute( const MPlug& plug, MDataBlock& block )
{
