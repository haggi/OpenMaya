...
// Plugin asSurface_shader_collection Shader Class //
...
class asSurface_shader_collection : public MPxNode
{
public:
                    asSurface_shader_collection();
    virtual         ~asSurface_shader_collection();
...
//---------------------------- automatically created attributes start ------------------------------------
	static    MObject surface_shader2;
	static    MObject surface_shader3;
	static    MObject surface_shader1;
	static    MObject surface_shader6;
	static    MObject surface_shader7;
	static    MObject surface_shader4;
	static    MObject surface_shader5;
	static    MObject surface_shader8;
