#ifndef MTAP_CONSTANT_SHADER_H
#define MTAP_CONSTANT_SHADER_H

#include <maya/MPxNode.h>

const MString mtap_constantShaderName = "mtap_constantShader";

class mtap_constantShader : public MPxNode
{
public:
					mtap_constantShader();
	virtual			~mtap_constantShader();
