...
///////////////////////////////////////////////////////
//
MObject  mtap_smokeShader::aDiffuseReflectivity;
MObject  mtap_smokeShader::aInTransparency;
MObject  mtap_smokeShader::aInTransR;
MObject  mtap_smokeShader::aInTransG;
MObject  mtap_smokeShader::aInTransB;
MObject  mtap_smokeShader::aColor;
MObject  mtap_smokeShader::aColorR;
MObject  mtap_smokeShader::aColorG;
MObject  mtap_smokeShader::aColorB;
MObject  mtap_smokeShader::aIncandescence;
MObject  mtap_smokeShader::aIncandescenceR;
MObject  mtap_smokeShader::aIncandescenceG;
MObject  mtap_smokeShader::aIncandescenceB;
MObject  mtap_smokeShader::aOutColor;
MObject  mtap_smokeShader::aOutColorR;
MObject  mtap_smokeShader::aOutColorG;
MObject  mtap_smokeShader::aOutColorB;
MObject  mtap_smokeShader::aOutTransparency;
MObject  mtap_smokeShader::aOutTransR;
MObject  mtap_smokeShader::aOutTransG;
MObject  mtap_smokeShader::aOutTransB;
MObject  mtap_smokeShader::aNormalCamera;
MObject  mtap_smokeShader::aNormalCameraX;
MObject  mtap_smokeShader::aNormalCameraY;
MObject  mtap_smokeShader::aNormalCameraZ;
MObject  mtap_smokeShader::aLightData;
MObject  mtap_smokeShader::aLightDirection;
MObject  mtap_smokeShader::aLightDirectionX;
MObject  mtap_smokeShader::aLightDirectionY;
MObject  mtap_smokeShader::aLightDirectionZ;
MObject  mtap_smokeShader::aLightIntensity; 
MObject  mtap_smokeShader::aLightIntensityR;
MObject  mtap_smokeShader::aLightIntensityG;
MObject  mtap_smokeShader::aLightIntensityB;
MObject  mtap_smokeShader::aLightAmbient;
MObject  mtap_smokeShader::aLightDiffuse;
MObject  mtap_smokeShader::aLightSpecular;
MObject  mtap_smokeShader::aLightShadowFraction;
MObject  mtap_smokeShader::aPreShadowIntensity;
MObject  mtap_smokeShader::aLightBlindData;



mtap_smokeShader::mtap_smokeShader() { }
mtap_smokeShader::~mtap_smokeShader() { }


void* mtap_smokeShader::creator()
{
	return new mtap_smokeShader();
}

MStatus mtap_smokeShader::initialize()
{
...
//
MStatus mtap_smokeShader::compute( const MPlug& plug, MDataBlock& block ) 
{ 
