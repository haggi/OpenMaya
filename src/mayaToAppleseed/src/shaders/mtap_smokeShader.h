#ifndef MTAP_SMOKESURFACE_SHADER_H
#define MTAP_SMOKESURFACE_SHADER_H

#include <maya/MPxNode.h>

const MString mtap_smokeShaderName = "mtap_smokeShader";

class mtap_smokeShader : public MPxNode
{
public:
					mtap_smokeShader();
	virtual			~mtap_smokeShader();
