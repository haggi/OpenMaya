...
//Name: iesLights.ma
//Last modified: Thu, May 01, 2014 12:39:21 PM
//Codeset: 1252
requires maya "2014";
...
requires -nodeType "CoronaSurface" -nodeType "coronaGlobals" "mayatocorona" "0.24";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 49.175591095814418 22.477029776292664 28.701866267580048 ;
	setAttr ".r" -type "double3" -14.738352729607545 66.200000000001012 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 66.299711391259152;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.10000000000001 2.1119935146794186e-014 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 111.89322659110402;
...
createNode transform -n "floor";
	setAttr ".s" -type "double3" 34.108029407182649 34.108029407182649 62.340308269900071 ;
...
createNode transform -n "wall";
	setAttr ".t" -type "double3" -16.09724946612187 4.9842679428086516 0 ;
	setAttr ".r" -type "double3" 0 0 -90 ;
	setAttr ".s" -type "double3" 34.108029407182649 34.108029407182649 63.23710681281942 ;
...
createNode transform -n "light1";
	setAttr ".t" -type "double3" -15.34704751961501 17.76057206590751 12.452440908679879 ;
	setAttr ".r" -type "double3" 0 0 180 ;
createNode mesh -n "lightShape1" -p "light1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "light2";
	setAttr ".t" -type "double3" -15.34704751961501 17.76057206590751 0.23551956296439336 ;
	setAttr ".r" -type "double3" 0 0 180 ;
...
createNode transform -n "light3";
	setAttr ".t" -type "double3" -15.34704751961501 17.76057206590751 -12.866524782911881 ;
	setAttr ".r" -type "double3" 0 0 180 ;
createNode mesh -n "lightShape3" -p "light3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode polyPlane -n "polyPlane2";
	setAttr ".cuv" 2;
createNode CoronaSurface -n "LightMat1";
	setAttr ".emissionColor" -type "float3" 10 10 10 ;
	setAttr ".mtco_mat_iesProfile" -type "string" "H:/UserDatenHaggi/Documents/coding/OpenMaya/src/mayaToCorona/mayaToCoronaExamples//renderData/IESProfiles/23.ies";
createNode shadingEngine -n "CoronaSurface1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode CoronaSurface -n "LightMat2";
	setAttr ".emissionColor" -type "float3" 10 10 10 ;
	setAttr ".mtco_mat_iesProfile" -type "string" "H:/UserDatenHaggi/Documents/coding/OpenMaya/src/mayaToCorona/mayaToCoronaExamples//renderData/IESProfiles/12.IES";
createNode CoronaSurface -n "LightMat3";
	setAttr ".diffuse" -type "float3" 1 1 1 ;
	setAttr ".emissionColor" -type "float3" 10 10 10 ;
	setAttr ".mtco_mat_iesProfile" -type "string" "H:/UserDatenHaggi/Documents/coding/OpenMaya/src/mayaToCorona/mayaToCoronaExamples//renderData/IESProfiles/1.IES";
createNode shadingEngine -n "LightMat2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
createNode shadingEngine -n "LightMat3SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
createNode coronaGlobals -n "coronaGlobals";
	...
	setAttr ".imageName" -type "string" "iesLights";
...
connectAttr "polyPlane2.out" "lightShape1.i";
relationship "link" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "CoronaSurface1SG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "LightMat2SG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "LightMat3SG.message" ":defaultLightSet.message";
...
relationship "shadowLink" ":lightLinker1" "LightMat2SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "LightMat3SG.message" ":defaultLightSet.message";
...
connectAttr "LightMat1.diffuse" "LightMat1.c";
connectAttr "LightMat1.emissionColor" "LightMat1.ic";
connectAttr "LightMat1.oc" "CoronaSurface1SG.ss";
connectAttr "lightShape1.iog" "CoronaSurface1SG.dsm" -na;
connectAttr "CoronaSurface1SG.msg" "materialInfo1.sg";
connectAttr "LightMat1.msg" "materialInfo1.m";
connectAttr "LightMat1.msg" "materialInfo1.t" -na;
connectAttr "LightMat2.diffuse" "LightMat2.c";
connectAttr "LightMat2.emissionColor" "LightMat2.ic";
connectAttr "LightMat3.diffuse" "LightMat3.c";
connectAttr "LightMat3.emissionColor" "LightMat3.ic";
connectAttr "LightMat2.oc" "LightMat2SG.ss";
connectAttr "lightShape2.iog" "LightMat2SG.dsm" -na;
connectAttr "LightMat2SG.msg" "materialInfo2.sg";
connectAttr "LightMat2.msg" "materialInfo2.m";
connectAttr "LightMat2.msg" "materialInfo2.t" -na;
connectAttr "LightMat3.oc" "LightMat3SG.ss";
connectAttr "lightShape3.iog" "LightMat3SG.dsm" -na;
connectAttr "LightMat3SG.msg" "materialInfo3.sg";
connectAttr "LightMat3.msg" "materialInfo3.m";
connectAttr "LightMat3.msg" "materialInfo3.t" -na;
connectAttr "CoronaSurface2.diffuse" "CoronaSurface2.c";
connectAttr "CoronaSurface2.emissionColor" "CoronaSurface2.ic";
connectAttr "CoronaSurface2.oc" "CoronaSurface2SG.ss";
connectAttr "wallShape.iog" "CoronaSurface2SG.dsm" -na;
connectAttr "floorShape.iog" "CoronaSurface2SG.dsm" -na;
connectAttr "CoronaSurface2SG.msg" "materialInfo4.sg";
connectAttr "CoronaSurface2.msg" "materialInfo4.m";
connectAttr "CoronaSurface2.msg" "materialInfo4.t" -na;
connectAttr "CoronaSurface1SG.pa" ":renderPartition.st" -na;
connectAttr "LightMat2SG.pa" ":renderPartition.st" -na;
connectAttr "LightMat3SG.pa" ":renderPartition.st" -na;
connectAttr "CoronaSurface2SG.pa" ":renderPartition.st" -na;
connectAttr "LightMat1.msg" ":defaultShaderList1.s" -na;
connectAttr "LightMat2.msg" ":defaultShaderList1.s" -na;
connectAttr "LightMat3.msg" ":defaultShaderList1.s" -na;
