...
class AECoronaRaytypeTemplate(BaseTemplate):
    ...
    def buildBody(self, nodeName):
        ...
        self.addControl("reflect", label="Reflected Material")
        self.addControl("refract", label="Refracted Material")
        self.addControl("direct", label="Directly visible Material")
        self.endNoOptimize()
        self.endLayout()
