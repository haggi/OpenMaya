            ...
            with pm.columnLayout(self.rendererName + "ColumnLayout", adjustableColumn=True, width=400):                
                with pm.frameLayout(label="Renderer", collapsable=True, collapse=False):
                    with pm.columnLayout(self.rendererName + 'ColumnLayout', adjustableColumn=True, width=400):
                        ...
                        pm.separator()
                        self.addRenderGlobalsUIElement(attName = 'bidir_doMis', uiType = 'bool', displayName = 'Do MIS', default='true', uiDict=uiDict)
                ...
                with pm.frameLayout(label="Raytrace Features", collapsable=True, collapse=False):
                    with pm.columnLayout(self.rendererName + 'ColumnLayout', adjustableColumn=True, width=400):
                        ...
                        with pm.frameLayout(label="Accerleration Structure", collapsable=True, collapse=False):
                            with pm.columnLayout(self.rendererName + 'ColumnLayout', adjustableColumn=True, width=400):
