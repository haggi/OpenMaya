...
MObject MayaToCoronaGlobals::bitdepth;
MObject MayaToCoronaGlobals::colorSpace;
MObject MayaToCoronaGlobals::filtertype;
MObject MayaToCoronaGlobals::lightingEngine;
MObject MayaToCoronaGlobals::clamping;
MObject MayaToCoronaGlobals::maxError;
MObject MayaToCoronaGlobals::caustics;
MObject MayaToCoronaGlobals::diffuseDepth;
MObject MayaToCoronaGlobals::glossyDepth;
MObject MayaToCoronaGlobals::exportXMLFile;
MObject MayaToCoronaGlobals::exportXMLFileName;
MObject MayaToCoronaGlobals::assemblyExportType;
MObject MayaToCoronaGlobals::environmentColor;
MObject MayaToCoronaGlobals::environmentType;
MObject MayaToCoronaGlobals::environmentIntensity;
MObject MayaToCoronaGlobals::gradientHorizon;
MObject MayaToCoronaGlobals::gradientZenit;
MObject MayaToCoronaGlobals::directLightSamples;
MObject MayaToCoronaGlobals::imageFormat;
MObject MayaToCoronaGlobals::environmentMap;
MObject MayaToCoronaGlobals::assemblyPolyTheshold;
MObject MayaToCoronaGlobals::optimizedTexturePath;
MObject MayaToCoronaGlobals::sceneScale;
MObject MayaToCoronaGlobals::latlongHoShift;
MObject MayaToCoronaGlobals::latlongVeShift;
