...
//	------------- automatically created attributes start ----------- // 
	...
	int bvh_leafSizeMin;
	int bvh_leafSizeMax;
	float colorMapping_exponent;
	float colorMapping_gamma;
	float colorMapping_whiteMultiplier;
	float colorMapping_displayTemperature;
	float colorMapping_sceneTemperature;
	float colorMapping_rBalance;
	float colorMapping_gBalance;
