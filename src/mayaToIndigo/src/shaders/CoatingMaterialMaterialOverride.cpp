...
MHWRender::MPxSurfaceShadingNodeOverride* CoatingMaterialOverride::creator(const MObject& obj)
{
	return new CoatingMaterialOverride(obj);
}

CoatingMaterialOverride::CoatingMaterialOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

CoatingMaterialOverride::~CoatingMaterialOverride()
{
}

MHWRender::DrawAPI CoatingMaterialOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString CoatingMaterialOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void CoatingMaterialOverride::getCustomMappings(
...
MString CoatingMaterialOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString CoatingMaterialOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString CoatingMaterialOverride::bumpAttribute() const
{
