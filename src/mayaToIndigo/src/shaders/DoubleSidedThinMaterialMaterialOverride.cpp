...
MHWRender::MPxSurfaceShadingNodeOverride* DoubleSidedThinMaterialOverride::creator(const MObject& obj)
{
	return new DoubleSidedThinMaterialOverride(obj);
}

DoubleSidedThinMaterialOverride::DoubleSidedThinMaterialOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

DoubleSidedThinMaterialOverride::~DoubleSidedThinMaterialOverride()
{
}

MHWRender::DrawAPI DoubleSidedThinMaterialOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString DoubleSidedThinMaterialOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void DoubleSidedThinMaterialOverride::getCustomMappings(
...
MString DoubleSidedThinMaterialOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString DoubleSidedThinMaterialOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString DoubleSidedThinMaterialOverride::bumpAttribute() const
{
