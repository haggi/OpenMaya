...
#include "inBlendOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* inBlendOverride::creator(const MObject& obj)
{
	return new inBlendOverride(obj);
}

inBlendOverride::inBlendOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

inBlendOverride::~inBlendOverride()
{
}

MHWRender::DrawAPI inBlendOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString inBlendOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void inBlendOverride::getCustomMappings(
...
MString inBlendOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString inBlendOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString inBlendOverride::bumpAttribute() const
{
