...
//
MTypeId	inDiffuse::id( 0x0011CF7F );
...
//
void inDiffuse::postConstructor( )
{
...
//
MObject  inDiffuse::aTranslucenceCoeff;
MObject  inDiffuse::aDiffuseReflectivity;
MObject  inDiffuse::aInTransparency;
MObject  inDiffuse::aColor;
MObject  inDiffuse::aIncandescence;
MObject  inDiffuse::aOutColor;
MObject  inDiffuse::aOutTransparency;
MObject  inDiffuse::aNormalCamera;
MObject  inDiffuse::aNormalCameraX;
MObject  inDiffuse::aNormalCameraY;
MObject  inDiffuse::aNormalCameraZ;
MObject  inDiffuse::aLightData;
MObject  inDiffuse::aLightDirection;
MObject  inDiffuse::aLightDirectionX;
MObject  inDiffuse::aLightDirectionY;
MObject  inDiffuse::aLightDirectionZ;
MObject  inDiffuse::aLightIntensity;
MObject  inDiffuse::aLightIntensityR;
MObject  inDiffuse::aLightIntensityG;
MObject  inDiffuse::aLightIntensityB;
MObject  inDiffuse::aLightAmbient;
MObject  inDiffuse::aLightDiffuse;
MObject  inDiffuse::aLightSpecular;
MObject  inDiffuse::aLightShadowFraction;
MObject  inDiffuse::aPreShadowIntensity;
...
// method.
//
// In this case creator simply returns a new inDiffuse object.
//

void* inDiffuse::creator()
{
    return new inDiffuse();
}
...
//
MStatus inDiffuse::compute( const MPlug& plug, MDataBlock& block )
{
