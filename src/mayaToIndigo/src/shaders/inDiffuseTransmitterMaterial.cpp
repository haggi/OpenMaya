#include "inDiffuseTransmitterMaterial.h"
...
//
void inDiffuseTransmitter::postConstructor( )
{
...
//
MObject  inDiffuseTransmitter::aTranslucenceCoeff;
MObject  inDiffuseTransmitter::aDiffuseReflectivity;
MObject  inDiffuseTransmitter::aInTransparency;
MObject  inDiffuseTransmitter::aColor;
MObject  inDiffuseTransmitter::aIncandescence;
MObject  inDiffuseTransmitter::aOutColor;
MObject  inDiffuseTransmitter::aOutTransparency;
MObject  inDiffuseTransmitter::aNormalCamera;
MObject  inDiffuseTransmitter::aNormalCameraX;
MObject  inDiffuseTransmitter::aNormalCameraY;
MObject  inDiffuseTransmitter::aNormalCameraZ;
MObject  inDiffuseTransmitter::aLightData;
MObject  inDiffuseTransmitter::aLightDirection;
MObject  inDiffuseTransmitter::aLightDirectionX;
MObject  inDiffuseTransmitter::aLightDirectionY;
MObject  inDiffuseTransmitter::aLightDirectionZ;
MObject  inDiffuseTransmitter::aLightIntensity;
MObject  inDiffuseTransmitter::aLightIntensityR;
MObject  inDiffuseTransmitter::aLightIntensityG;
MObject  inDiffuseTransmitter::aLightIntensityB;
MObject  inDiffuseTransmitter::aLightAmbient;
MObject  inDiffuseTransmitter::aLightDiffuse;
MObject  inDiffuseTransmitter::aLightSpecular;
MObject  inDiffuseTransmitter::aLightShadowFraction;
MObject  inDiffuseTransmitter::aPreShadowIntensity;
MObject  inDiffuseTransmitter::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject inDiffuseTransmitter::backface_emit;
MObject inDiffuseTransmitter::layer;
MObject inDiffuseTransmitter::iesProfile;
MObject inDiffuseTransmitter::internal_medium_name;
MObject inDiffuseTransmitter::bump;
...
inDiffuseTransmitter::inDiffuseTransmitter() { }
inDiffuseTransmitter::~inDiffuseTransmitter() { }
...
// method.
//
// In this case creator simply returns a new inDiffuseTransmitter object.
//

void* inDiffuseTransmitter::creator()
{
    return new inDiffuseTransmitter();
}
...
MStatus inDiffuseTransmitter::initialize()
{
...
//
MStatus inDiffuseTransmitter::compute( const MPlug& plug, MDataBlock& block )
{
