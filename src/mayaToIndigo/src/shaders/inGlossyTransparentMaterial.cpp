#include "inGlossyTransparentMaterial.h"
...
//
void inGlossyTransparent::postConstructor( )
{
...
//
MObject  inGlossyTransparent::aTranslucenceCoeff;
MObject  inGlossyTransparent::aDiffuseReflectivity;
MObject  inGlossyTransparent::aInTransparency;
MObject  inGlossyTransparent::aColor;
MObject  inGlossyTransparent::aIncandescence;
MObject  inGlossyTransparent::aOutColor;
MObject  inGlossyTransparent::aOutTransparency;
MObject  inGlossyTransparent::aNormalCamera;
MObject  inGlossyTransparent::aNormalCameraX;
MObject  inGlossyTransparent::aNormalCameraY;
MObject  inGlossyTransparent::aNormalCameraZ;
MObject  inGlossyTransparent::aLightData;
MObject  inGlossyTransparent::aLightDirection;
MObject  inGlossyTransparent::aLightDirectionX;
MObject  inGlossyTransparent::aLightDirectionY;
MObject  inGlossyTransparent::aLightDirectionZ;
MObject  inGlossyTransparent::aLightIntensity;
MObject  inGlossyTransparent::aLightIntensityR;
MObject  inGlossyTransparent::aLightIntensityG;
MObject  inGlossyTransparent::aLightIntensityB;
MObject  inGlossyTransparent::aLightAmbient;
MObject  inGlossyTransparent::aLightDiffuse;
MObject  inGlossyTransparent::aLightSpecular;
MObject  inGlossyTransparent::aLightShadowFraction;
MObject  inGlossyTransparent::aPreShadowIntensity;
...
inGlossyTransparent::inGlossyTransparent() { }
inGlossyTransparent::~inGlossyTransparent() { }
...
// method.
//
// In this case creator simply returns a new inGlossyTransparent object.
//

void* inGlossyTransparent::creator()
{
    return new inGlossyTransparent();
}
...
MStatus inGlossyTransparent::initialize()
{
...
//
MStatus inGlossyTransparent::compute( const MPlug& plug, MDataBlock& block )
{
