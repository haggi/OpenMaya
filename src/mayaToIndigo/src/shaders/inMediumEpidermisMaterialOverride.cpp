...
MHWRender::MPxSurfaceShadingNodeOverride* inMediumEpidermisOverride::creator(const MObject& obj)
{
	return new inMediumEpidermisOverride(obj);
}

inMediumEpidermisOverride::inMediumEpidermisOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

inMediumEpidermisOverride::~inMediumEpidermisOverride()
{
}

MHWRender::DrawAPI inMediumEpidermisOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString inMediumEpidermisOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void inMediumEpidermisOverride::getCustomMappings(
...
MString inMediumEpidermisOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString inMediumEpidermisOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString inMediumEpidermisOverride::bumpAttribute() const
{
