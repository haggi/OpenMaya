...
//
MObject  inNull::aTranslucenceCoeff;
MObject  inNull::aDiffuseReflectivity;
MObject  inNull::aInTransparency;
MObject  inNull::aColor;
MObject  inNull::aIncandescence;
MObject  inNull::aOutColor;
MObject  inNull::aOutTransparency;
MObject  inNull::aNormalCamera;
MObject  inNull::aNormalCameraX;
MObject  inNull::aNormalCameraY;
MObject  inNull::aNormalCameraZ;
MObject  inNull::aLightData;
MObject  inNull::aLightDirection;
MObject  inNull::aLightDirectionX;
MObject  inNull::aLightDirectionY;
MObject  inNull::aLightDirectionZ;
MObject  inNull::aLightIntensity;
MObject  inNull::aLightIntensityR;
MObject  inNull::aLightIntensityG;
MObject  inNull::aLightIntensityB;
MObject  inNull::aLightAmbient;
MObject  inNull::aLightDiffuse;
MObject  inNull::aLightSpecular;
MObject  inNull::aLightShadowFraction;
MObject  inNull::aPreShadowIntensity;
...
// method.
//
// In this case creator simply returns a new inNull object.
//
...
//
MStatus inNull::compute( const MPlug& plug, MDataBlock& block )
{
