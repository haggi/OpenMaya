...
#include "inOrenNayarOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* inOrenNayarOverride::creator(const MObject& obj)
{
	return new inOrenNayarOverride(obj);
}

inOrenNayarOverride::inOrenNayarOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

inOrenNayarOverride::~inOrenNayarOverride()
{
}

MHWRender::DrawAPI inOrenNayarOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString inOrenNayarOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void inOrenNayarOverride::getCustomMappings(
...
MString inOrenNayarOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString inOrenNayarOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString inOrenNayarOverride::bumpAttribute() const
{
