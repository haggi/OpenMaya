...
//
MObject  inPhong::aTranslucenceCoeff;
MObject  inPhong::aDiffuseReflectivity;
MObject  inPhong::aInTransparency;
MObject  inPhong::aColor;
MObject  inPhong::aIncandescence;
MObject  inPhong::aOutColor;
MObject  inPhong::aOutTransparency;
MObject  inPhong::aNormalCamera;
MObject  inPhong::aNormalCameraX;
MObject  inPhong::aNormalCameraY;
MObject  inPhong::aNormalCameraZ;
MObject  inPhong::aLightData;
MObject  inPhong::aLightDirection;
MObject  inPhong::aLightDirectionX;
MObject  inPhong::aLightDirectionY;
MObject  inPhong::aLightDirectionZ;
MObject  inPhong::aLightIntensity;
MObject  inPhong::aLightIntensityR;
MObject  inPhong::aLightIntensityG;
MObject  inPhong::aLightIntensityB;
MObject  inPhong::aLightAmbient;
MObject  inPhong::aLightDiffuse;
MObject  inPhong::aLightSpecular;
MObject  inPhong::aLightShadowFraction;
MObject  inPhong::aPreShadowIntensity;
MObject  inPhong::aLightBlindData;
...
// method.
//
// In this case creator simply returns a new inPhong object.
//

void* inPhong::creator()
{
    return new inPhong();
}
...
//
MStatus inPhong::compute( const MPlug& plug, MDataBlock& block )
{
