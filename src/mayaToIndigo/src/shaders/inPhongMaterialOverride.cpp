...
#include "inPhongOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* inPhongOverride::creator(const MObject& obj)
{
	return new inPhongOverride(obj);
}

inPhongOverride::inPhongOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

inPhongOverride::~inPhongOverride()
{
}

MHWRender::DrawAPI inPhongOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString inPhongOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void inPhongOverride::getCustomMappings(
...
MString inPhongOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString inPhongOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString inPhongOverride::bumpAttribute() const
{
