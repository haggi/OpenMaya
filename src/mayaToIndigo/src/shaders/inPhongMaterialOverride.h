#ifndef inPhongOverride_H
#define inPhongOverride_H
...
// the node defined in inPhong.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class inPhongOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~inPhongOverride();
...
private:
	inPhongOverride(const MObject& obj);
};

#endif // _inPhongOverride
