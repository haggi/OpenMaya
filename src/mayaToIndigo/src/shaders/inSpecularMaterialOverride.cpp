...
#include "inSpecularOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* inSpecularOverride::creator(const MObject& obj)
{
	return new inSpecularOverride(obj);
}

inSpecularOverride::inSpecularOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

inSpecularOverride::~inSpecularOverride()
{
}

MHWRender::DrawAPI inSpecularOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString inSpecularOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void inSpecularOverride::getCustomMappings(
...
MString inSpecularOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString inSpecularOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString inSpecularOverride::bumpAttribute() const
{
