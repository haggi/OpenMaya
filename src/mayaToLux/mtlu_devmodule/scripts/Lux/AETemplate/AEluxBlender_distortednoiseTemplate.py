...
class AEluxBlender_distortednoiseTemplate(BaseTemplate):
    def __init__(self, nodeName):
        BaseTemplate.__init__(self,nodeName)
        log.debug("AEluxBlender_distortednoiseTemplate")
        self.thisNode = None
    ...
    def buildBody(self, nodeName):
        ...
        self.addControl("type", label="Distort Noise Pattern")
        self.addControl("distamount", label="Amount of Distortion")
        self.addSeparator()
        #autoAddEnd
        self.endNoOptimize()
        self.endLayout()
