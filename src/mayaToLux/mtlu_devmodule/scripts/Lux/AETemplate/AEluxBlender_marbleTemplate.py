...
class AEluxBlender_marbleTemplate(BaseTemplate):
    def __init__(self, nodeName):
        BaseTemplate.__init__(self,nodeName)
        log.debug("AEluxBlender_marbleTemplate")
        self.thisNode = None
    ...
    def buildBody(self, nodeName):
        ...
        self.addControl("noisebasis2", label="Noise Basis 2")
        ...
        self.addControl("turbulance", label="Turbulence")
