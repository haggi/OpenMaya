...
class AEluxCarpaintTemplate(BaseTemplate):
    ...
    def buildBody(self, nodeName):
        ...
        #autoAddBegin
        self.addControl("Ks1", label="Spec Component 1")
        self.addControl("R1", label="Fresnel constant1")
        self.addControl("Ks3", label="Spec Component 3")
        self.addControl("Ks2", label="Spec Component 2")
        self.addControl("R3", label="Fresnel constant3")
        self.addControl("Kd", label="Diffuse component")
        self.addControl("R2", label="Fresnel constant2")
        self.addControl("M1", label="Microfacet roughness 3")
        self.addControl("M3", label="Microfacet roughness 3")
        self.addControl("M2", label="Microfacet roughness 3")
        self.addControl("name", label="Carpaint Model")
        self.addSeparator()
