...
class AEluxMarbleTemplate(BaseTemplate):
    def __init__(self, nodeName):
        BaseTemplate.__init__(self,nodeName)
        log.debug("AEluxMarbleTemplate")
        self.thisNode = None
    ...
    def buildBody(self, nodeName):
        ...
        #autoAddBegin
        self.addControl("scale", label="Noise Scaling")
        ...
        self.addControl("variation", label="Perturbation Magnitude")
