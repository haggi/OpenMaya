...
class AEluxMattetranslucentTemplate(BaseTemplate):
    ...
    def buildBody(self, nodeName):
        ...
        self.addControl("mattetranslucent_Kt", label="Transmission")
        self.addControl("mattetranslucent_energyconserving", label="Engergy Conserving")
        self.addControl("mattetranslucent_sigma", label="Sigma")
        self.addControl("mattetranslucent_Kr", label="Diffuse Reflection")
        #autoAddEnd
        self.endLayout()