...
//
MTypeId	carpaint::id( 0x0011CF5F );
...
//
MObject  carpaint::aTranslucenceCoeff;
MObject  carpaint::aDiffuseReflectivity;
MObject  carpaint::aInTransparency;
MObject  carpaint::aColor;
MObject  carpaint::aIncandescence;
MObject  carpaint::aOutColor;
MObject  carpaint::aOutTransparency;
MObject  carpaint::aNormalCamera;
MObject  carpaint::aNormalCameraX;
MObject  carpaint::aNormalCameraY;
MObject  carpaint::aNormalCameraZ;
MObject  carpaint::aLightData;
MObject  carpaint::aLightDirection;
MObject  carpaint::aLightDirectionX;
MObject  carpaint::aLightDirectionY;
MObject  carpaint::aLightDirectionZ;
MObject  carpaint::aLightIntensity;
MObject  carpaint::aLightIntensityR;
MObject  carpaint::aLightIntensityG;
MObject  carpaint::aLightIntensityB;
MObject  carpaint::aLightAmbient;
MObject  carpaint::aLightDiffuse;
MObject  carpaint::aLightSpecular;
MObject  carpaint::aLightShadowFraction;
MObject  carpaint::aPreShadowIntensity;
MObject  carpaint::aLightBlindData;
...
// method.
//
// In this case creator simply returns a new carpaint object.
//

void* carpaint::creator()
{
    return new carpaint();
}
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	status = eAttr.addField( "bmw339", 3 );
	status = eAttr.addField( "2k acrylack", 4 );
...
//
MStatus carpaint::compute( const MPlug& plug, MDataBlock& block )
{
