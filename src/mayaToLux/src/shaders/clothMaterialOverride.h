#ifndef clothOverride_H
#define clothOverride_H
...
// the node defined in cloth.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class clothOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~clothOverride();
...
private:
	clothOverride(const MObject& obj);
};

#endif // _clothOverride
