...
//
MObject  glass2::aTranslucenceCoeff;
MObject  glass2::aDiffuseReflectivity;
MObject  glass2::aInTransparency;
MObject  glass2::aColor;
MObject  glass2::aIncandescence;
MObject  glass2::aOutColor;
MObject  glass2::aOutTransparency;
MObject  glass2::aNormalCamera;
MObject  glass2::aNormalCameraX;
MObject  glass2::aNormalCameraY;
MObject  glass2::aNormalCameraZ;
MObject  glass2::aLightData;
MObject  glass2::aLightDirection;
MObject  glass2::aLightDirectionX;
MObject  glass2::aLightDirectionY;
MObject  glass2::aLightDirectionZ;
MObject  glass2::aLightIntensity;
MObject  glass2::aLightIntensityR;
MObject  glass2::aLightIntensityG;
MObject  glass2::aLightIntensityB;
MObject  glass2::aLightAmbient;
MObject  glass2::aLightDiffuse;
MObject  glass2::aLightSpecular;
MObject  glass2::aLightShadowFraction;
MObject  glass2::aPreShadowIntensity;
...
// method.
//
// In this case creator simply returns a new glass2 object.
//
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	glasss2_dispersion = nAttr.create("glasss2_dispersion", "glasss2_dispersion",  MFnNumericData::kBoolean, false);
	CHECK_MSTATUS(addAttribute( glasss2_dispersion ));
...
//
MStatus glass2::compute( const MPlug& plug, MDataBlock& block )
{
