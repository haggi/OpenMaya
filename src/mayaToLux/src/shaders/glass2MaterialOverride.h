#ifndef glass2Override_H
#define glass2Override_H
...
// the node defined in glass2.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class glass2Override : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~glass2Override();
...
private:
	glass2Override(const MObject& obj);
};

#endif // _glass2Override
