...
//
MObject  glass::aTranslucenceCoeff;
MObject  glass::aDiffuseReflectivity;
MObject  glass::aInTransparency;
MObject  glass::aColor;
MObject  glass::aIncandescence;
MObject  glass::aOutColor;
MObject  glass::aOutTransparency;
MObject  glass::aNormalCamera;
MObject  glass::aNormalCameraX;
MObject  glass::aNormalCameraY;
MObject  glass::aNormalCameraZ;
MObject  glass::aLightData;
MObject  glass::aLightDirection;
MObject  glass::aLightDirectionX;
MObject  glass::aLightDirectionY;
MObject  glass::aLightDirectionZ;
MObject  glass::aLightIntensity;
MObject  glass::aLightIntensityR;
MObject  glass::aLightIntensityG;
MObject  glass::aLightIntensityB;
MObject  glass::aLightAmbient;
MObject  glass::aLightDiffuse;
MObject  glass::aLightSpecular;
MObject  glass::aLightShadowFraction;
MObject  glass::aPreShadowIntensity;
...
// method.
//
// In this case creator simply returns a new glass object.
//
...
//
MStatus glass::compute( const MPlug& plug, MDataBlock& block )
{
