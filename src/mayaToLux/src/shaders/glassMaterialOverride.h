#ifndef glassOverride_H
#define glassOverride_H
...
// the node defined in glass.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class glassOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~glassOverride();
...
private:
	glassOverride(const MObject& obj);
};

#endif // _glassOverride
