#ifndef glossyOverride_H
#define glossyOverride_H
...
// the node defined in glossy.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class glossyOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~glossyOverride();
...
private:
	glossyOverride(const MObject& obj);
};

#endif // _glossyOverride
