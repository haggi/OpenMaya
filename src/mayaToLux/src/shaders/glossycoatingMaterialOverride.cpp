...
#include "glossycoatingMaterialOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* glossycoatingOverride::creator(const MObject& obj)
{
	return new glossycoatingOverride(obj);
}

glossycoatingOverride::glossycoatingOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

glossycoatingOverride::~glossycoatingOverride()
{
}

MHWRender::DrawAPI glossycoatingOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString glossycoatingOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void glossycoatingOverride::getCustomMappings(
...
MString glossycoatingOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString glossycoatingOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString glossycoatingOverride::bumpAttribute() const
{
