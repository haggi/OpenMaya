#ifndef layeredOverride_H
#define layeredOverride_H
...
// the node defined in layered.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class layeredOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~layeredOverride();
...
private:
	layeredOverride(const MObject& obj);
};

#endif // _layeredOverride
