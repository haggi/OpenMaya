...
//
MObject  matte::aTranslucenceCoeff;
MObject  matte::aDiffuseReflectivity;
MObject  matte::aInTransparency;
MObject  matte::aColor;
MObject  matte::aIncandescence;
MObject  matte::aOutColor;
MObject  matte::aOutTransparency;
MObject  matte::aNormalCamera;
MObject  matte::aNormalCameraX;
MObject  matte::aNormalCameraY;
MObject  matte::aNormalCameraZ;
MObject  matte::aLightData;
MObject  matte::aLightDirection;
MObject  matte::aLightDirectionX;
MObject  matte::aLightDirectionY;
MObject  matte::aLightDirectionZ;
MObject  matte::aLightIntensity;
MObject  matte::aLightIntensityR;
MObject  matte::aLightIntensityG;
MObject  matte::aLightIntensityB;
MObject  matte::aLightAmbient;
MObject  matte::aLightDiffuse;
MObject  matte::aLightSpecular;
MObject  matte::aLightShadowFraction;
MObject  matte::aPreShadowIntensity;
MObject  matte::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject matte::matte_Kd;
MObject matte::matte_sigma;
MObject matte::compo_visible_material;
MObject matte::compo_override_alpha_value;
MObject matte::compo_visible_emission;
MObject matte::compo_override_alpha;
MObject matte::compo_visible_indirect_material;
MObject matte::bumpmap;
MObject matte::compo_visible_indirect_emission;
...
// method.
//
// In this case creator simply returns a new matte object.
//
...
//---------------------------- automatically created attributes start ------------------------------------
	matte_Kd = nAttr.createColor("matte_Kd", "matte_Kd");
	nAttr.setDefault(1.0);
	CHECK_MSTATUS(addAttribute( matte_Kd ));

	matte_sigma = nAttr.create("matte_sigma", "matte_sigma",  MFnNumericData::kFloat, 0.0);
	CHECK_MSTATUS(addAttribute( matte_sigma ));
...
//
MStatus matte::compute( const MPlug& plug, MDataBlock& block )
{
