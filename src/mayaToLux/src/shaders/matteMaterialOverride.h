#ifndef matteOverride_H
#define matteOverride_H
...
// the node defined in matte.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class matteOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~matteOverride();
...
private:
	matteOverride(const MObject& obj);
};

#endif // _matteOverride
