#include "mattetranslucentMaterial.h"
...
//
MTypeId	mattetranslucent::id( 0x0011CF4F );
...
//
void mattetranslucent::postConstructor( )
{
...
//
MObject  mattetranslucent::aTranslucenceCoeff;
MObject  mattetranslucent::aDiffuseReflectivity;
MObject  mattetranslucent::aInTransparency;
MObject  mattetranslucent::aColor;
MObject  mattetranslucent::aIncandescence;
MObject  mattetranslucent::aOutColor;
MObject  mattetranslucent::aOutTransparency;
MObject  mattetranslucent::aNormalCamera;
MObject  mattetranslucent::aNormalCameraX;
MObject  mattetranslucent::aNormalCameraY;
MObject  mattetranslucent::aNormalCameraZ;
MObject  mattetranslucent::aLightData;
MObject  mattetranslucent::aLightDirection;
MObject  mattetranslucent::aLightDirectionX;
MObject  mattetranslucent::aLightDirectionY;
MObject  mattetranslucent::aLightDirectionZ;
MObject  mattetranslucent::aLightIntensity;
MObject  mattetranslucent::aLightIntensityR;
MObject  mattetranslucent::aLightIntensityG;
MObject  mattetranslucent::aLightIntensityB;
MObject  mattetranslucent::aLightAmbient;
MObject  mattetranslucent::aLightDiffuse;
MObject  mattetranslucent::aLightSpecular;
MObject  mattetranslucent::aLightShadowFraction;
MObject  mattetranslucent::aPreShadowIntensity;
...
mattetranslucent::mattetranslucent() { }
mattetranslucent::~mattetranslucent() { }
...
// method.
//
// In this case creator simply returns a new mattetranslucent object.
//

void* mattetranslucent::creator()
{
    return new mattetranslucent();
}
...
MStatus mattetranslucent::initialize()
{
...
//
MStatus mattetranslucent::compute( const MPlug& plug, MDataBlock& block )
{
