...
//
MObject  metal2::aTranslucenceCoeff;
MObject  metal2::aDiffuseReflectivity;
MObject  metal2::aInTransparency;
MObject  metal2::aColor;
MObject  metal2::aIncandescence;
MObject  metal2::aOutColor;
MObject  metal2::aOutTransparency;
MObject  metal2::aNormalCamera;
MObject  metal2::aNormalCameraX;
MObject  metal2::aNormalCameraY;
MObject  metal2::aNormalCameraZ;
MObject  metal2::aLightData;
MObject  metal2::aLightDirection;
MObject  metal2::aLightDirectionX;
MObject  metal2::aLightDirectionY;
MObject  metal2::aLightDirectionZ;
MObject  metal2::aLightIntensity;
MObject  metal2::aLightIntensityR;
MObject  metal2::aLightIntensityG;
MObject  metal2::aLightIntensityB;
MObject  metal2::aLightAmbient;
MObject  metal2::aLightDiffuse;
MObject  metal2::aLightSpecular;
MObject  metal2::aLightShadowFraction;
MObject  metal2::aPreShadowIntensity;
MObject  metal2::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject metal2::compo_visible_indirect_material;
MObject metal2::metal2_uroughness;
MObject metal2::compo_override_alpha_value;
MObject metal2::compo_visible_emission;
MObject metal2::compo_override_alpha;
MObject metal2::compo_visible_material;
MObject metal2::metal2_vroughness;
MObject metal2::bumpmap;
MObject metal2::compo_visible_indirect_emission;
MObject metal2::metal2_fresnel;
...
// method.
//
// In this case creator simply returns a new metal2 object.
//
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	metal2_uroughness = nAttr.create("metal2_uroughness", "metal2_uroughness",  MFnNumericData::kFloat, 0.001);
	CHECK_MSTATUS(addAttribute( metal2_uroughness ));
	...
	metal2_vroughness = nAttr.create("metal2_vroughness", "metal2_vroughness",  MFnNumericData::kFloat, 0.001);
	CHECK_MSTATUS(addAttribute( metal2_vroughness ));
	...
	metal2_fresnel = nAttr.create("metal2_fresnel", "metal2_fresnel",  MFnNumericData::kFloat, 5.0);
	CHECK_MSTATUS(addAttribute( metal2_fresnel ));
...
//
MStatus metal2::compute( const MPlug& plug, MDataBlock& block )
{
