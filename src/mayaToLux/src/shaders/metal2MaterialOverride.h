#ifndef metal2Override_H
#define metal2Override_H
...
// the node defined in metal2.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class metal2Override : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~metal2Override();
...
private:
	metal2Override(const MObject& obj);
};

#endif // _metal2Override
