...
//
MObject  metal::aTranslucenceCoeff;
MObject  metal::aDiffuseReflectivity;
MObject  metal::aInTransparency;
MObject  metal::aColor;
MObject  metal::aIncandescence;
MObject  metal::aOutColor;
MObject  metal::aOutTransparency;
MObject  metal::aNormalCamera;
MObject  metal::aNormalCameraX;
MObject  metal::aNormalCameraY;
MObject  metal::aNormalCameraZ;
MObject  metal::aLightData;
MObject  metal::aLightDirection;
MObject  metal::aLightDirectionX;
MObject  metal::aLightDirectionY;
MObject  metal::aLightDirectionZ;
MObject  metal::aLightIntensity;
MObject  metal::aLightIntensityR;
MObject  metal::aLightIntensityG;
MObject  metal::aLightIntensityB;
MObject  metal::aLightAmbient;
MObject  metal::aLightDiffuse;
MObject  metal::aLightSpecular;
MObject  metal::aLightShadowFraction;
MObject  metal::aPreShadowIntensity;
MObject  metal::aLightBlindData;
...
// method.
//
// In this case creator simply returns a new metal object.
//
...
//
MStatus metal::compute( const MPlug& plug, MDataBlock& block )
{
