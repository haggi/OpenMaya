...
//
MObject  mirror::aTranslucenceCoeff;
MObject  mirror::aDiffuseReflectivity;
MObject  mirror::aInTransparency;
MObject  mirror::aColor;
MObject  mirror::aIncandescence;
MObject  mirror::aOutColor;
MObject  mirror::aOutTransparency;
MObject  mirror::aNormalCamera;
MObject  mirror::aNormalCameraX;
MObject  mirror::aNormalCameraY;
MObject  mirror::aNormalCameraZ;
MObject  mirror::aLightData;
MObject  mirror::aLightDirection;
MObject  mirror::aLightDirectionX;
MObject  mirror::aLightDirectionY;
MObject  mirror::aLightDirectionZ;
MObject  mirror::aLightIntensity;
MObject  mirror::aLightIntensityR;
MObject  mirror::aLightIntensityG;
MObject  mirror::aLightIntensityB;
MObject  mirror::aLightAmbient;
MObject  mirror::aLightDiffuse;
MObject  mirror::aLightSpecular;
MObject  mirror::aLightShadowFraction;
MObject  mirror::aPreShadowIntensity;
MObject  mirror::aLightBlindData;
...
// method.
//
// In this case creator simply returns a new mirror object.
//
...
//
MStatus mirror::compute( const MPlug& plug, MDataBlock& block )
{
