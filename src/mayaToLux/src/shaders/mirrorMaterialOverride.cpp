...
#include "mirrorMaterialOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* mirrorOverride::creator(const MObject& obj)
{
	return new mirrorOverride(obj);
}

mirrorOverride::mirrorOverride(const MObject& obj)
...
MHWRender::DrawAPI mirrorOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString mirrorOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void mirrorOverride::getCustomMappings(
