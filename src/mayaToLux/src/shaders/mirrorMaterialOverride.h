#ifndef mirrorOverride_H
#define mirrorOverride_H
...
// the node defined in mirror.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class mirrorOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~mirrorOverride();
...
private:
	mirrorOverride(const MObject& obj);
};

#endif // _mirrorOverride
