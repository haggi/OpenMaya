...
//
MObject  mix::aTranslucenceCoeff;
MObject  mix::aDiffuseReflectivity;
MObject  mix::aInTransparency;
MObject  mix::aColor;
MObject  mix::aIncandescence;
MObject  mix::aOutColor;
MObject  mix::aOutTransparency;
MObject  mix::aNormalCamera;
MObject  mix::aNormalCameraX;
MObject  mix::aNormalCameraY;
MObject  mix::aNormalCameraZ;
MObject  mix::aLightData;
MObject  mix::aLightDirection;
MObject  mix::aLightDirectionX;
MObject  mix::aLightDirectionY;
MObject  mix::aLightDirectionZ;
MObject  mix::aLightIntensity;
MObject  mix::aLightIntensityR;
MObject  mix::aLightIntensityG;
MObject  mix::aLightIntensityB;
MObject  mix::aLightAmbient;
MObject  mix::aLightDiffuse;
MObject  mix::aLightSpecular;
MObject  mix::aLightShadowFraction;
MObject  mix::aPreShadowIntensity;
MObject  mix::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject mix::compo_visible_indirect_material;
...
// method.
//
// In this case creator simply returns a new mix object.
//
