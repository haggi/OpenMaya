#ifndef mixOverride_H
#define mixOverride_H
...
// the node defined in mix.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class mixOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
