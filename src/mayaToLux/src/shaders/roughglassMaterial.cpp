...
//
MTypeId roughglass::id( 0x0011CF53 );
...
//
void roughglass::postConstructor( )
{
...
//
MObject  roughglass::aTranslucenceCoeff;
MObject  roughglass::aDiffuseReflectivity;
MObject  roughglass::aInTransparency;
MObject  roughglass::aColor;
MObject  roughglass::aIncandescence;
MObject  roughglass::aOutColor;
MObject  roughglass::aOutTransparency;
MObject  roughglass::aNormalCamera;
MObject  roughglass::aNormalCameraX;
MObject  roughglass::aNormalCameraY;
MObject  roughglass::aNormalCameraZ;
MObject  roughglass::aLightData;
MObject  roughglass::aLightDirection;
MObject  roughglass::aLightDirectionX;
MObject  roughglass::aLightDirectionY;
MObject  roughglass::aLightDirectionZ;
MObject  roughglass::aLightIntensity;
MObject  roughglass::aLightIntensityR;
MObject  roughglass::aLightIntensityG;
MObject  roughglass::aLightIntensityB;
MObject  roughglass::aLightAmbient;
MObject  roughglass::aLightDiffuse;
MObject  roughglass::aLightSpecular;
MObject  roughglass::aLightShadowFraction;
MObject  roughglass::aPreShadowIntensity;
...
// method.
//
// In this case creator simply returns a new roughglass object.
//

void* roughglass::creator()
{
    return new roughglass();
}
...
//
MStatus roughglass::compute( const MPlug& plug, MDataBlock& block )
{
