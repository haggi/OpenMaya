...
//
MObject  scatter::aTranslucenceCoeff;
MObject  scatter::aDiffuseReflectivity;
MObject  scatter::aInTransparency;
MObject  scatter::aColor;
MObject  scatter::aIncandescence;
MObject  scatter::aOutColor;
MObject  scatter::aOutTransparency;
MObject  scatter::aNormalCamera;
MObject  scatter::aNormalCameraX;
MObject  scatter::aNormalCameraY;
MObject  scatter::aNormalCameraZ;
MObject  scatter::aLightData;
MObject  scatter::aLightDirection;
MObject  scatter::aLightDirectionX;
MObject  scatter::aLightDirectionY;
MObject  scatter::aLightDirectionZ;
MObject  scatter::aLightIntensity;
MObject  scatter::aLightIntensityR;
MObject  scatter::aLightIntensityG;
MObject  scatter::aLightIntensityB;
MObject  scatter::aLightAmbient;
MObject  scatter::aLightDiffuse;
MObject  scatter::aLightSpecular;
MObject  scatter::aLightShadowFraction;
MObject  scatter::aPreShadowIntensity;
MObject  scatter::aLightBlindData;
...
// method.
//
// In this case creator simply returns a new scatter object.
//

void* scatter::creator()
{
    return new scatter();
}
...
//
MStatus scatter::compute( const MPlug& plug, MDataBlock& block )
{
