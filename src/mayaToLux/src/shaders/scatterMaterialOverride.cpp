...
#include "scatterMaterialOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* scatterOverride::creator(const MObject& obj)
{
	return new scatterOverride(obj);
}

scatterOverride::scatterOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

scatterOverride::~scatterOverride()
{
}

MHWRender::DrawAPI scatterOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString scatterOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void scatterOverride::getCustomMappings(
...
MString scatterOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString scatterOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString scatterOverride::bumpAttribute() const
{
