...
//
MObject  velvet::aTranslucenceCoeff;
MObject  velvet::aDiffuseReflectivity;
MObject  velvet::aInTransparency;
MObject  velvet::aColor;
MObject  velvet::aIncandescence;
MObject  velvet::aOutColor;
MObject  velvet::aOutTransparency;
MObject  velvet::aNormalCamera;
MObject  velvet::aNormalCameraX;
MObject  velvet::aNormalCameraY;
MObject  velvet::aNormalCameraZ;
MObject  velvet::aLightData;
MObject  velvet::aLightDirection;
MObject  velvet::aLightDirectionX;
MObject  velvet::aLightDirectionY;
MObject  velvet::aLightDirectionZ;
MObject  velvet::aLightIntensity;
MObject  velvet::aLightIntensityR;
MObject  velvet::aLightIntensityG;
MObject  velvet::aLightIntensityB;
MObject  velvet::aLightAmbient;
MObject  velvet::aLightDiffuse;
MObject  velvet::aLightSpecular;
MObject  velvet::aLightShadowFraction;
MObject  velvet::aPreShadowIntensity;
...
// method.
//
// In this case creator simply returns a new velvet object.
//
...
//
MStatus velvet::compute( const MPlug& plug, MDataBlock& block )
{
