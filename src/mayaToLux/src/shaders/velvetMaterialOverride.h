#ifndef velvetOverride_H
#define velvetOverride_H
...
// the node defined in velvet.cpp. This provides draw support in
// Viewport 2.0.
//

#include <maya/MPxSurfaceShadingNodeOverride.h>

class velvetOverride : public MHWRender::MPxSurfaceShadingNodeOverride
{
public:
	static MHWRender::MPxSurfaceShadingNodeOverride* creator(const MObject& obj);

	virtual ~velvetOverride();
...
private:
	velvetOverride(const MObject& obj);
};

#endif // _velvetOverride
