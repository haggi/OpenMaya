...
)
{
	...
	int tstyle = 0;
	vector clr = {0,0,0};
    vector blinnSpec = vop_lighting("blinn", nf, ii, uvw, ambientColor, clr, specularColor, eccentricity, vrough, tstyle);
	...
	outColor = inColor + blinnSpec + reflectedColor + refractedColor + translucenceColor;
