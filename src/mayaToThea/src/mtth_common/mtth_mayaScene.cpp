...
{
	mtth_MayaObject *obj = (mtth_MayaObject *)mobj;
	logger.trace(MString("mtth_MayaScene::deformUpdateCallback"));
...
{
	logger.debug("mtth_MayaScene::translateShaders");
	return true;
}

bool mtth_MayaScene::translateShapes(int timeStep)
{
	logger.debug("mtth_MayaScene::translateShapes");
	return true;
}

bool mtth_MayaScene::doPreRenderJobs()
{
	logger.debug("mtth_MayaScene::doPreRenderJobs");
	return true;
}

bool mtth_MayaScene::doPreFrameJobs()
{
	logger.debug("mtth_MayaScene::doPreFrameJobs");
...
{
	logger.debug("mtth_MayaScene::doPostFrameJobs");
	MString result;
...
{
	logger.debug("mtth_MayaScene::doPostRenderJobs");
	return true;
}
...
{
	logger.debug("mtth_MayaScene::renderImage");
...
{
	logger.debug("mtth_MayaScene::postParseCallback");
