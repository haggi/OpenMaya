...
//
MTypeId	BasicBSDF::id( 0x0011EF5B );
...
//
void BasicBSDF::postConstructor( )
{
...
//
MObject  BasicBSDF::aTranslucenceCoeff;
MObject  BasicBSDF::aDiffuseReflectivity;
MObject  BasicBSDF::aInTransparency;
MObject  BasicBSDF::aColor;
MObject  BasicBSDF::aIncandescence;
MObject  BasicBSDF::aOutColor;
MObject  BasicBSDF::aOutTransparency;
MObject  BasicBSDF::aNormalCamera;
MObject  BasicBSDF::aNormalCameraX;
MObject  BasicBSDF::aNormalCameraY;
MObject  BasicBSDF::aNormalCameraZ;
MObject  BasicBSDF::aLightData;
MObject  BasicBSDF::aLightDirection;
MObject  BasicBSDF::aLightDirectionX;
MObject  BasicBSDF::aLightDirectionY;
MObject  BasicBSDF::aLightDirectionZ;
MObject  BasicBSDF::aLightIntensity;
MObject  BasicBSDF::aLightIntensityR;
MObject  BasicBSDF::aLightIntensityG;
MObject  BasicBSDF::aLightIntensityB;
MObject  BasicBSDF::aLightAmbient;
MObject  BasicBSDF::aLightDiffuse;
MObject  BasicBSDF::aLightSpecular;
MObject  BasicBSDF::aLightShadowFraction;
MObject  BasicBSDF::aPreShadowIntensity;
MObject  BasicBSDF::aLightBlindData;
...
MObject BasicBSDF::absorptionDensity;
...
// method.
//
// In this case creator simply returns a new BasicBSDF object.
//

void* BasicBSDF::creator()
{
    return new BasicBSDF();
}
...
//
MStatus BasicBSDF::compute( const MPlug& plug, MDataBlock& block )
{
