...
//
MTypeId	BssdfBSDF::id( 0x0011EF58 );
...
//
void BssdfBSDF::postConstructor( )
{
...
//
MObject  BssdfBSDF::aTranslucenceCoeff;
MObject  BssdfBSDF::aDiffuseReflectivity;
MObject  BssdfBSDF::aInTransparency;
MObject  BssdfBSDF::aColor;
MObject  BssdfBSDF::aIncandescence;
MObject  BssdfBSDF::aOutColor;
MObject  BssdfBSDF::aOutTransparency;
MObject  BssdfBSDF::aNormalCamera;
MObject  BssdfBSDF::aNormalCameraX;
MObject  BssdfBSDF::aNormalCameraY;
MObject  BssdfBSDF::aNormalCameraZ;
MObject  BssdfBSDF::aLightData;
MObject  BssdfBSDF::aLightDirection;
MObject  BssdfBSDF::aLightDirectionX;
MObject  BssdfBSDF::aLightDirectionY;
MObject  BssdfBSDF::aLightDirectionZ;
MObject  BssdfBSDF::aLightIntensity;
MObject  BssdfBSDF::aLightIntensityR;
MObject  BssdfBSDF::aLightIntensityG;
MObject  BssdfBSDF::aLightIntensityB;
MObject  BssdfBSDF::aLightAmbient;
MObject  BssdfBSDF::aLightDiffuse;
MObject  BssdfBSDF::aLightSpecular;
MObject  BssdfBSDF::aLightShadowFraction;
MObject  BssdfBSDF::aPreShadowIntensity;
MObject  BssdfBSDF::aLightBlindData;
...
MObject BssdfBSDF::absorptionDensity;
MObject BssdfBSDF::ior;
MObject BssdfBSDF::roughness;
MObject BssdfBSDF::asymmetry;
MObject BssdfBSDF::scatteringDensity;
MObject BssdfBSDF::traceReflections;
MObject BssdfBSDF::scatteringColor;
MObject BssdfBSDF::rotation;
MObject BssdfBSDF::transmittedRoughness;
...
// method.
//
// In this case creator simply returns a new BssdfBSDF object.
//

void* BssdfBSDF::creator()
{
    return new BssdfBSDF();
}
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	ior = nAttr.create("ior", "ior",  MFnNumericData::kFloat, 1.3);
	CHECK_MSTATUS(addAttribute( ior ));

	roughness = nAttr.create("roughness", "roughness",  MFnNumericData::kFloat, 0.0);
	CHECK_MSTATUS(addAttribute( roughness ));

	asymmetry = nAttr.create("asymmetry", "asymmetry",  MFnNumericData::kFloat, 0.0);
	CHECK_MSTATUS(addAttribute( asymmetry ));

	scatteringDensity = nAttr.create("scatteringDensity", "scatteringDensity",  MFnNumericData::kFloat, 1000.0);
	CHECK_MSTATUS(addAttribute( scatteringDensity ));
	...
	scatteringColor = nAttr.createColor("scatteringColor", "scatteringColor");
	nAttr.setDefault(1,1,1);
...
//
MStatus BssdfBSDF::compute( const MPlug& plug, MDataBlock& block )
{
