...
class BssdfBSDF : public MPxNode
{
public:
                    BssdfBSDF();
    virtual         ~BssdfBSDF();
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	static    MObject absorptionDensity;
	static    MObject ior;
	static    MObject roughness;
	static    MObject asymmetry;
	static    MObject scatteringDensity;
	static    MObject traceReflections;
	static    MObject scatteringColor;
