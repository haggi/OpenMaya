...
#include "BssdfBSDFOverride.h"

MHWRender::MPxSurfaceShadingNodeOverride* BssdfBSDFOverride::creator(const MObject& obj)
{
	return new BssdfBSDFOverride(obj);
}

BssdfBSDFOverride::BssdfBSDFOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

BssdfBSDFOverride::~BssdfBSDFOverride()
{
}

MHWRender::DrawAPI BssdfBSDFOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString BssdfBSDFOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void BssdfBSDFOverride::getCustomMappings(
...
MString BssdfBSDFOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString BssdfBSDFOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString BssdfBSDFOverride::bumpAttribute() const
{
