...
//
MTypeId	CoatingBSDF::id( 0x0011EF5A );
...
//
void CoatingBSDF::postConstructor( )
{
...
//
MObject  CoatingBSDF::aTranslucenceCoeff;
MObject  CoatingBSDF::aDiffuseReflectivity;
MObject  CoatingBSDF::aInTransparency;
MObject  CoatingBSDF::aColor;
MObject  CoatingBSDF::aIncandescence;
MObject  CoatingBSDF::aOutColor;
MObject  CoatingBSDF::aOutTransparency;
MObject  CoatingBSDF::aNormalCamera;
MObject  CoatingBSDF::aNormalCameraX;
MObject  CoatingBSDF::aNormalCameraY;
MObject  CoatingBSDF::aNormalCameraZ;
MObject  CoatingBSDF::aLightData;
MObject  CoatingBSDF::aLightDirection;
MObject  CoatingBSDF::aLightDirectionX;
MObject  CoatingBSDF::aLightDirectionY;
MObject  CoatingBSDF::aLightDirectionZ;
MObject  CoatingBSDF::aLightIntensity;
MObject  CoatingBSDF::aLightIntensityR;
MObject  CoatingBSDF::aLightIntensityG;
MObject  CoatingBSDF::aLightIntensityB;
MObject  CoatingBSDF::aLightAmbient;
MObject  CoatingBSDF::aLightDiffuse;
MObject  CoatingBSDF::aLightSpecular;
MObject  CoatingBSDF::aLightShadowFraction;
MObject  CoatingBSDF::aPreShadowIntensity;
MObject  CoatingBSDF::aLightBlindData;

//---------------------------- automatically created attributes start ------------------------------------
MObject CoatingBSDF::normalMapping;
...
MObject CoatingBSDF::coatingAbsorption;
MObject CoatingBSDF::microRoughness;
MObject CoatingBSDF::rotation;
MObject CoatingBSDF::thickness;
MObject CoatingBSDF::microRoughnessWidth;
...
// method.
//
// In this case creator simply returns a new CoatingBSDF object.
//

void* CoatingBSDF::creator()
{
    return new CoatingBSDF();
}
