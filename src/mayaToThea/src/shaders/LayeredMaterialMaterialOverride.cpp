...
MHWRender::MPxSurfaceShadingNodeOverride* LayeredMaterialOverride::creator(const MObject& obj)
{
	return new LayeredMaterialOverride(obj);
}

LayeredMaterialOverride::LayeredMaterialOverride(const MObject& obj)
: MPxSurfaceShadingNodeOverride(obj)
{
}

LayeredMaterialOverride::~LayeredMaterialOverride()
{
}

MHWRender::DrawAPI LayeredMaterialOverride::supportedDrawAPIs() const
{
	// works in both gl and dx
	return MHWRender::kOpenGL | MHWRender::kDirectX11;
}

MString LayeredMaterialOverride::fragmentName() const
{
	// Just reuse Maya's lambert surface shader
	return "mayaLambertSurface";
}

void LayeredMaterialOverride::getCustomMappings(
...
MString LayeredMaterialOverride::primaryColorParameter() const
{
	// Use the color parameter from the lambert fragment as the primary color
	return "color";
}

MString LayeredMaterialOverride::transparencyParameter() const
{
	// Use the "transparency" parameter from the lambert fragment for transparency
	return "transparency";
}

MString LayeredMaterialOverride::bumpAttribute() const
{
