#include "ThinFilmBSDFMaterial.h"
...
//
MTypeId	ThinFilmBSDF::id( 0x0011EF5C );
...
//
void ThinFilmBSDF::postConstructor( )
{
...
//
MObject  ThinFilmBSDF::aTranslucenceCoeff;
MObject  ThinFilmBSDF::aDiffuseReflectivity;
MObject  ThinFilmBSDF::aInTransparency;
MObject  ThinFilmBSDF::aColor;
MObject  ThinFilmBSDF::aIncandescence;
MObject  ThinFilmBSDF::aOutColor;
MObject  ThinFilmBSDF::aOutTransparency;
MObject  ThinFilmBSDF::aNormalCamera;
MObject  ThinFilmBSDF::aNormalCameraX;
MObject  ThinFilmBSDF::aNormalCameraY;
MObject  ThinFilmBSDF::aNormalCameraZ;
MObject  ThinFilmBSDF::aLightData;
MObject  ThinFilmBSDF::aLightDirection;
MObject  ThinFilmBSDF::aLightDirectionX;
MObject  ThinFilmBSDF::aLightDirectionY;
MObject  ThinFilmBSDF::aLightDirectionZ;
MObject  ThinFilmBSDF::aLightIntensity;
MObject  ThinFilmBSDF::aLightIntensityR;
MObject  ThinFilmBSDF::aLightIntensityG;
MObject  ThinFilmBSDF::aLightIntensityB;
MObject  ThinFilmBSDF::aLightAmbient;
MObject  ThinFilmBSDF::aLightDiffuse;
MObject  ThinFilmBSDF::aLightSpecular;
MObject  ThinFilmBSDF::aLightShadowFraction;
MObject  ThinFilmBSDF::aPreShadowIntensity;
MObject  ThinFilmBSDF::aLightBlindData;
...
// method.
//
// In this case creator simply returns a new ThinFilmBSDF object.
//

void* ThinFilmBSDF::creator()
{
    return new ThinFilmBSDF();
}
...
MStatus ThinFilmBSDF::initialize()
{
...
//---------------------------- automatically created attributes start ------------------------------------
	...
	ior = nAttr.create("ior", "ior",  MFnNumericData::kFloat, 1.52);
	CHECK_MSTATUS(addAttribute( ior ));

	thickness = nAttr.create("thickness", "thickness",  MFnNumericData::kInt, 500);
...
//
MStatus ThinFilmBSDF::compute( const MPlug& plug, MDataBlock& block )
{
